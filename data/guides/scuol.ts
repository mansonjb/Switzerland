...
// Sources in data/SOURCES-scuol.md (checked 16/09/2026). No number without a source.
export const scuol: DestinationGuide = {
  slug: 'scuol',
  stamp: 'generic',
  updated: '2026-09-16',
  meta: {
  ...
  title: { en: 'Where to stay in Scuol', fr: 'Où dormir à Scuol', de: 'Wo übernachten in Scuol' },
  intro: {
    en: 'Scuol sits at 1250 m in the Lower Engadine, canton Graubünden, and is the seat of a municipality with about 4,600 residents that describes itself as the largest in Switzerland by area, spanning the villages of Ardez, Ftan, Guarda, Scuol, Sent and Tarasp. Romansh is a living language here, and the municipal website itself is written in it. Scuol-Tarasp is the terminus of the Rhaetian Railway’s Engadine line, reached from Zürich HB in 2 h 37 with one change at Landquart.',
    fr: 'Scuol se trouve à 1250 m en Basse-Engadine, canton des Grisons, siège d’une commune d’environ 4600 habitants qui se présente comme la plus étendue de Suisse, englobant les villages d’Ardez, Ftan, Guarda, Scuol, Sent et Tarasp. Le romanche y est une langue vivante, et le site de la commune est lui-même rédigé dans cette langue. Scuol-Tarasp est le terminus de la ligne de l’Engadine des Chemins de fer rhétiques, accessible depuis Zürich HB en 2 h 37 avec un changement à Landquart.',
    de: 'Scuol liegt auf 1250 m im Unterengadin, Kanton Graubünden, und ist Sitz einer Gemeinde mit rund 4600 Einwohnerinnen und Einwohnern, die sich als flächengrösste der Schweiz bezeichnet und die Dörfer Ardez, Ftan, Guarda, Scuol, Sent und Tarasp umfasst. Rätoromanisch ist hier eine gelebte Sprache, und die Gemeindewebsite selbst ist darin verfasst. Scuol-Tarasp ist die Endstation der Engadinlinie der Rhätischen Bahn, ab Zürich HB in 2 Std. 37 mit einem Umstieg in Landquart erreichbar.',
  },
  quickAnswer: {
    en: 'Stay on the Stradun for the Bogn Engiadina mineral baths and the Motta Naluns gondola, both a few steps from the tourist office; choose the old village quarters for the mineral-water fountains and a quieter Engadine house; or cross the Inn to Tarasp and Vulpera for the castle and the golf course. Scuol sits in the Lower Engadine, at the other end of Graubünden from Laax and Flims, and its draw is the mineral baths, not a shared ski area.',
    fr: 'Dormez sur le Stradun pour les bains minéraux du Bogn Engiadina et la télécabine de Motta Naluns, à quelques pas de l’office du tourisme ; choisissez les vieux quartiers du village pour les fontaines d’eau minérale et une maison engadinoise plus calme ; ou traversez l’Inn jusqu’à Tarasp et Vulpera pour le château et le golf. Scuol se trouve en Basse-Engadine, à l’autre bout des Grisons par rapport à Laax et Flims, et son atout, ce sont les bains minéraux, pas un domaine skiable partagé.',
    de: 'Übernachten Sie am Stradun für das Mineralbad Bogn Engiadina und die Gondelbahn Motta Naluns, beide nur wenige Schritte vom Tourismusbüro entfernt; wählen Sie die alten Dorfquartiere für die Mineralwasserbrunnen und ein ruhigeres Engadiner Haus; oder überqueren Sie den Inn nach Tarasp und Vulpera für das Schloss und den Golfplatz. Scuol liegt im Unterengadin, am anderen Ende Graubündens gegenüber Laax und Flims, und sein Trumpf sind die Mineralbäder, nicht ein gemeinsames Skigebiet.',
  },
  snapshot: {
    why: {
    ...
    where: {
      ...
      fr: 'Le Stradun pour les bains minéraux et la télécabine de Motta Naluns ; les vieux quartiers du village pour les fontaines et le Boutique Hotel ÜJA ; Tarasp et Vulpera, de l’autre côté de l’Inn, pour le château et le golf.',
      de: 'Der Stradun für die Mineralbäder und die Gondelbahn Motta Naluns; die alten Dorfquartiere für die Brunnen und das Boutique Hotel ÜJA; Tarasp und Vulpera, jenseits des Inn, für das Schloss und den Golfplatz.',
    },
    watch: {
      en: 'The Clemgia gorge below the old village is closed until further notice. The Bogn Engiadina sauna area stays closed until early October 2026. Scuol has no published Swiss Travel Pass coverage; what it has instead is a free Guestcard from your first night, described below.',
      fr: 'Les gorges de la Clemgia, sous le vieux village, sont fermées jusqu’à nouvel avis. La zone sauna du Bogn Engiadina reste fermée jusqu’à début octobre 2026. Scuol ne publie aucune couverture du Swiss Travel Pass ; en revanche, une Guestcard gratuite est offerte dès la première nuitée, décrite plus bas.',
  ...
  hero: {
    photo: '/photos/scuol.jpg',
    caption: { en: 'Scuol, canton Graubünden, at 1250 m.', fr: 'Scuol, canton des Grisons, à 1250 m.', de: 'Scuol, Kanton Graubünden, auf 1250 m.' },
    credit: { author: 'Daniel Schwen', license: 'CC BY-SA 4.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0', source: 'https://commons.wikimedia.org/wiki/File:CH_Scuol.jpg' },
  },
  sectors: [
    {
      title: { en: 'The Stradun and the baths', fr: 'Le Stradun et les bains', de: 'Der Stradun und das Bad' },
      walk: { en: 'The lively main street, with the Bogn Engiadina mineral bath and the Motta Naluns valley station', fr: 'La rue principale animée, avec le bain minéral Bogn Engiadina et la gare aval de Motta Naluns', de: 'Die belebte Hauptstrasse, mit dem Mineralbad Bogn Engiadina und der Talstation Motta Naluns' },
      text: {
        en: 'The Stradun is Scuol’s lively main street, where the tourist office sits at Stradun 403a, alongside the Bogn Engiadina mineral bath and the valley station of the Motta Naluns gondola. Four hotels connect straight indoors to the bath: Hotel Belvedere, Boutique-Hotel GuardaVal, Badehotel Belvair and Hotel Astras.',
        fr: 'Le Stradun est la rue principale animée de Scuol, où l’office du tourisme se trouve au 403a, aux côtés du bain minéral Bogn Engiadina et de la gare aval de la télécabine de Motta Naluns. Quatre hôtels sont reliés directement au bain : l’Hotel Belvedere, le Boutique-Hotel GuardaVal, le Badehotel Belvair et l’Hotel Astras.',
        de: 'Der Stradun ist die belebte Hauptstrasse von Scuol, an der das Tourismusbüro an der Stradun 403a liegt, zusammen mit dem Mineralbad Bogn Engiadina und der Talstation der Gondelbahn Motta Naluns. Vier Hotels sind direkt mit dem Bad verbunden: das Hotel Belvedere, das Boutique-Hotel GuardaVal, das Badehotel Belvair und das Hotel Astras.',
      },
      points: [
    ...
    },
    {
      ...
      walk: { en: 'The lower and upper old quarters below the Stradun', fr: 'Les quartiers anciens, bas et haut, sous le Stradun', de: 'Die unteren und oberen Altdorfquartiere unterhalb des Stradun' },
      text: {
        en: 'Below the Stradun lie Scuol’s old village quarters, where mineral water bubbles from the fountains in the alleys among sgraffito houses. The historic village centre hosts the Engadin Fountain Bath event, with dates published for 19 September and 18 October 2026. Boutique Hotel ÜJA, with 11 rooms, sits in the heart of the old village.',
        fr: 'Sous le Stradun se trouvent les vieux quartiers de Scuol, où l’eau minérale jaillit des fontaines des ruelles parmi les maisons à sgraffites. Le centre historique du village accueille l’événement du bain des fontaines engadinois, dont les dates du 19 septembre et du 18 octobre 2026 sont publiées. Le Boutique Hotel ÜJA, avec 11 chambres, se trouve au cœur du vieux village.',
        de: 'Unterhalb des Stradun liegen die alten Dorfquartiere von Scuol, wo Mineralwasser aus den Brunnen in den Gassen zwischen Sgraffito-Häusern sprudelt. Im historischen Dorfzentrum findet das Engadiner Brunnenbad statt, mit publizierten Terminen am 19. September und 18. Oktober 2026. Das Boutique Hotel ÜJA, mit 11 Zimmern, liegt mitten im Herzen des alten Dorfes.',
      },
      points: [
    ...
    },
    {
      ...
      walk: { en: 'Across the Inn, the castle, Vulpera and the golf course', fr: 'De l’autre côté de l’Inn, le château, Vulpera et le golf', de: 'Jenseits des Inn, das Schloss, Vulpera und der Golfplatz' },
      text: {
        en: 'Across the valley from Scuol lie Tarasp castle and Vulpera, with a golf course the Belvedere hotels publish as 3 km from their door, with a 25% green fee reduction for their guests. In winter, a valid ski pass gives free travel on the bus between Scuol, Vulpera and Tarasp until 8.30 pm.',
        fr: 'De l’autre côté de la vallée se trouvent le château de Tarasp et Vulpera, avec un golf que les hôtels Belvedere annoncent à 3 km de leur porte, avec une réduction de 25% sur le green fee pour leurs clients. En hiver, un forfait de ski valide donne un accès gratuit au bus entre Scuol, Vulpera et Tarasp jusqu’à 20 h 30.',
        de: 'Auf der anderen Talseite liegen das Schloss Tarasp und Vulpera, mit einem Golfplatz, den die Belvedere-Hotels mit 3 km ab ihrer Tür angeben, samt 25% Ermässigung auf die Greenfee für ihre Gäste. Im Winter gibt ein gültiger Skipass freie Fahrt auf dem Bus zwischen Scuol, Vulpera und Tarasp bis 20.30 Uhr.',
      },
      points: [
  ...
  hotels: [
    {
      ...
      facts: [
        { en: 'Part of the Belvedere Hotel Family with GuardaVal and Belvair', fr: 'Fait partie de la famille d’hôtels Belvedere, avec GuardaVal et Belvair', de: 'Teil der Belvedere Hotel Family mit GuardaVal und Belvair' },
    ...
    },
    {
      ...
      facts: [
        { en: 'A 400-year-old Engadine house', fr: 'Une maison engadinoise vieille de 400 ans', de: 'Ein 400 Jahre altes Engadiner Haus' },
    ...
    },
    {
      ...
      sector: { en: 'The Stradun and the baths', fr: 'Le Stradun et les bains', de: 'Der Stradun und das Bad' },
      facts: [
        { en: 'Via da Brentsch 417, 7550 Scuol, above the Stradun, adults only', fr: 'Via da Brentsch 417, 7550 Scuol, au-dessus du Stradun, réservé aux adultes', de: 'Via da Brentsch 417, 7550 Scuol, über dem Stradun, nur für Erwachsene' },
    ...
    },
    {
      ...
      sector: { en: 'The old village quarters', fr: 'Les vieux quartiers du village', de: 'Die alten Dorfquartiere' },
      facts: [
        { en: '11 rooms, in the heart of Scuol', fr: '11 chambres, au cœur de Scuol', de: '11 Zimmer, mitten im Herzen von Scuol' },
  ...
  hotelsNote: {
    en: 'Facts taken from each hotel’s own website or the Bogn Engiadina and Engadin Scuol listings on 16 September 2026. No ratings or reviews on this guide.',
    fr: 'Faits relevés sur le site de chaque hôtel ou sur les fiches Bogn Engiadina et Engadin Scuol le 16 septembre 2026. Aucune note ni aucun avis sur ce guide.',
    de: 'Fakten von der Website des jeweiligen Hotels oder von den Einträgen bei Bogn Engiadina und Engadin Scuol, Stand 16. September 2026. Keine Bewertungen oder Rezensionen.',
  },
  practical: {
    title: { en: 'Getting to and around Scuol', fr: 'Rejoindre et se déplacer à Scuol', de: 'Nach Scuol reisen und sich fortbewegen' },
    items: [
      {
  ...
  seasons: {
    winter: {
      title: { en: 'Winter in Scuol', fr: 'L’hiver à Scuol', de: 'Winter in Scuol' },
      base: {
        en: 'Skiers do best on the Stradun, near the Motta Naluns valley station, or in Tarasp and Vulpera, where a valid ski pass covers the bus back into Scuol until 8.30 pm.',
        fr: 'Pour skier, privilégiez le Stradun, près de la gare aval de Motta Naluns, ou Tarasp et Vulpera, où un forfait de ski valide couvre le bus retour vers Scuol jusqu’à 20 h 30.',
        de: 'Skifahrer wohnen am besten am Stradun, nahe der Talstation Motta Naluns, oder in Tarasp und Vulpera, wo ein gültiger Skipass die Busfahrt zurück nach Scuol bis 20.30 Uhr abdeckt.',
      },
      facts: [
        { value: '70 km', label: { en: 'of pistes on Motta Naluns, 25 runs', fr: 'de pistes sur Motta Naluns, 25 pistes', de: 'Pisten auf Motta Naluns, 25 Pisten' } },
        { value: '13', label: { en: 'lift installations: one gondola, six chairlifts, three drag lifts, three magic carpets', fr: 'installations : une télécabine, six télésièges, trois téléskis, trois tapis roulants', de: 'Anlagen: eine Gondelbahn, sechs Sessellifte, drei Skilifte, drei Zauberteppiche' } },
        { value: '12.12 → 4.4', label: { en: 'winter season 2026/27', fr: 'saison d’hiver 2026/27', de: 'Wintersaison 2026/27' } },
        { value: '3.5 km', label: { en: 'toboggan run Prui to Ftan, with night tobogganing', fr: 'piste de luge de Prui à Ftan, avec luge nocturne', de: 'Schlittelbahn von Prui nach Ftan, mit Nachtschlitteln' } },
      ],
      note: {
        en: 'Sources: bergbahnen-scuol.ch, checked 16 September 2026.',
        fr: 'Sources : bergbahnen-scuol.ch, vérifiées le 16 septembre 2026.',
        de: 'Quellen: bergbahnen-scuol.ch, geprüft am 16. September 2026.',
      },
    },
    summer: {
      title: { en: 'Summer in Scuol', fr: 'L’été à Scuol', de: 'Sommer in Scuol' },
      base: {
        en: 'Bathers and walkers do best on the Stradun, at the Bogn Engiadina, open all year, or in the old village quarters for the mineral-water fountains.',
        fr: 'Pour la baignade et la randonnée, privilégiez le Stradun, au Bogn Engiadina, ouvert toute l’année, ou les vieux quartiers du village pour les fontaines d’eau minérale.',
        de: 'Badegäste und Wanderer wohnen am besten am Stradun, beim Bogn Engiadina, ganzjährig geöffnet, oder in den alten Dorfquartieren für die Mineralwasserbrunnen.',
      },
      facts: [
        { value: 'all year', label: { en: 'Bogn Engiadina mineral bath opening', fr: 'ouverture du bain minéral Bogn Engiadina', de: 'Öffnung des Mineralbads Bogn Engiadina' } },
        { value: '2.2 km', label: { en: 'Flurina Trail from the Motta Naluns mountain station, 1 h 30', fr: 'Flurina Trail depuis la station supérieure de Motta Naluns, 1 h 30', de: 'Flurina Trail ab der Bergstation Motta Naluns, 1 Std. 30' } },
        { value: '15.4 km', label: { en: 'Motta Naluns to Scuol via Ftan, 4 h 45', fr: 'de Motta Naluns à Scuol via Ftan, 4 h 45', de: 'von Motta Naluns nach Scuol via Ftan, 4 Std. 45' } },
        { value: '33 min', label: { en: 'Scuol-Tarasp to Zernez, gateway to the Swiss National Park', fr: 'de Scuol-Tarasp à Zernez, porte du Parc national suisse', de: 'von Scuol-Tarasp nach Zernez, Tor zum Schweizerischen Nationalpark' } },
      ],
      note: {
        en: 'Sources: engadin.com and bognengiadina.ch, checked 16 September 2026.',
        fr: 'Sources : engadin.com et bognengiadina.ch, vérifiées le 16 septembre 2026.',
        de: 'Quellen: engadin.com und bognengiadina.ch, geprüft am 16. September 2026.',
      },
    },
  },
  doing: {
    title: { en: 'What to do in Scuol', fr: 'Que faire à Scuol', de: 'Was man in Scuol unternimmt' },
    intro: {
      en: 'Not a trail guide: a handful of named places from Engadin Scuol Samnaun Val Müstair and Bergbahnen Scuol, to see what a day here looks like.',
      fr: 'Pas un guide de randonnée : une poignée de lieux nommés, repris d’Engadin Scuol Samnaun Val Müstair et de Bergbahnen Scuol, pour voir à quoi ressemble une journée ici.',
      de: 'Kein Wanderführer: eine Handvoll benannter Orte von Engadin Scuol Samnaun Val Müstair und Bergbahnen Scuol, damit Sie sehen, wie ein Tag hier aussieht.',
    },
    groups: [
      {
        kind: 'walk',
        title: { en: 'A simple loop from the mountain station, and a long descent through three alps', fr: 'Une boucle facile depuis la station supérieure, et une longue descente par trois alpages', de: 'Eine leichte Runde ab der Bergstation, und ein langer Abstieg über drei Alpen' },
        items: [
          {
            name: 'Flurina Trail',
            meta: { en: '2.2 km · 1 h 30 · from Motta Naluns', fr: '2,2 km · 1 h 30 · depuis Motta Naluns', de: '2,2 km · 1 Std. 30 · ab Motta Naluns' },
            text: {
              en: 'A simple 2.2 km loop from the Motta Naluns mountain station, published as 1 h 30, with 99 m of ascent and 18 m of descent.',
              fr: 'Une boucle simple de 2,2 km depuis la station supérieure de Motta Naluns, annoncée pour 1 h 30, avec 99 m de dénivelé positif et 18 m de dénivelé négatif.',
              de: 'Eine leichte 2,2 km lange Runde ab der Bergstation Motta Naluns, mit 1 Std. 30 angegeben, mit 99 Höhenmetern im Auf- und 18 im Abstieg.',
            },
          },
          {
            name: 'Motta Naluns to Alp Clünas, Alp Laret, Ftan and Scuol',
            meta: { en: '15.4 km · 4 h 45 · medium', fr: '15,4 km · 4 h 45 · moyen', de: '15,4 km · 4 Std. 45 · mittel' },
            text: {
              en: 'A medium route of 15.4 km, published as 4 h 45, with 362 m of ascent and 1,224 m of descent, from the mountain station down through Alp Clünas and Alp Laret to Ftan and Scuol.',
              fr: 'Un itinéraire de niveau moyen de 15,4 km, annoncé pour 4 h 45, avec 362 m de dénivelé positif et 1224 m de dénivelé négatif, de la station supérieure jusqu’à Ftan et Scuol via Alp Clünas et Alp Laret.',
              de: 'Eine mittelschwere Route von 15,4 km, mit 4 Std. 45 angegeben, mit 362 Höhenmetern im Auf- und 1224 im Abstieg, von der Bergstation über Alp Clünas und Alp Laret hinunter nach Ftan und Scuol.',
            },
          },
        ],
      },
      {
        kind: 'ride',
        title: { en: 'A gondola above the valley, and a car train through the mountain', fr: 'Une télécabine au-dessus de la vallée, et un train-navette à travers la montagne', de: 'Eine Gondelbahn über dem Tal, und ein Autoverlad durch den Berg' },
        items: [
          {
            name: 'Gondola Scuol to Motta Naluns',
            meta: { en: 'mountain station about 2,100 m', fr: 'station supérieure à environ 2100 m', de: 'Bergstation auf rund 2100 m' },
            text: {
              en: 'The gondola climbs from Scuol to the Motta Naluns mountain station, about 2,100 m above the Engadin valley, the starting point for the hiking network above town.',
              fr: 'La télécabine grimpe de Scuol jusqu’à la station supérieure de Motta Naluns, à environ 2100 m au-dessus de la vallée de l’Engadine, point de départ du réseau de randonnée au-dessus de la ville.',
              de: 'Die Gondelbahn fährt von Scuol zur Bergstation Motta Naluns, rund 2100 m über dem Engadiner Tal, dem Ausgangspunkt des Wanderwegnetzes oberhalb des Ortes.',
            },
          },
          {
            name: 'Vereina car-carrying train',
            meta: { en: 'Klosters Selfranga → Sagliains, 18 minutes', fr: 'Klosters Selfranga → Sagliains, 18 minutes', de: 'Klosters Selfranga → Sagliains, 18 Minuten' },
            text: {
              en: 'A car-carrying train through the Vereina tunnel, loading at Klosters Selfranga and reaching Sagliains, near Scuol, in 18 minutes, every 30 minutes.',
              fr: 'Un train-navette pour voitures à travers le tunnel de la Vereina, embarquement à Klosters Selfranga jusqu’à Sagliains, près de Scuol, en 18 minutes, toutes les 30 minutes.',
              de: 'Ein Autoverlad durch den Vereinatunnel, Verladung in Klosters Selfranga bis Sagliains, bei Scuol, in 18 Minuten, im 30-Minuten-Takt.',
            },
          },
        ],
      },
      {
        kind: 'local',
        title: { en: 'Six pools worth of mineral water, and the fountains that started it', fr: 'Six bassins d’eau minérale, et les fontaines à l’origine de tout cela', de: 'Sechs Becken voller Mineralwasser, und die Brunnen, die alles begannen' },
        items: [
          {
            name: 'Bogn Engiadina Scuol',
            meta: { en: 'open all year · Stradun', fr: 'ouvert toute l’année · Stradun', de: 'ganzjährig geöffnet · Stradun' },
            text: {
              en: 'Six indoor and outdoor pools with massage jets, bubbles, waterfalls and a swim-current channel, plus a brine pool at 2% salt; a free behind-the-scenes tour runs every Tuesday at 4 pm.',
              fr: 'Six bassins intérieurs et extérieurs avec jets de massage, bulles, cascades et un canal à courant de nage, plus un bassin de saumure à 2% de sel ; une visite gratuite des coulisses a lieu chaque mardi à 16 h.',
              de: 'Sechs Innen- und Aussenbecken mit Massagedüsen, Sprudel, Wasserfällen und einem Schwimmkanal mit Strömung, dazu ein Solebecken mit 2% Salzgehalt; jeden Dienstag um 16 Uhr findet eine gratis Blick-hinter-die-Kulissen-Führung statt.',
            },
          },
          {
            name: { en: 'Mineral water fountains of the old village', fr: 'Fontaines d’eau minérale du vieux village', de: 'Mineralwasserbrunnen des Altdorfs' },
            meta: { en: 'old village quarters', fr: 'vieux quartiers du village', de: 'alte Dorfquartiere' },
            text: {
              en: 'Signposted mineral water trails run circular routes through the old village quarters, where the water bubbles straight from the fountains in the alleys.',
              fr: 'Des sentiers de l’eau minérale, balisés, forment des boucles à travers les vieux quartiers du village, où l’eau jaillit directement des fontaines des ruelles.',
              de: 'Signalisierte Mineralwasserwege führen als Rundwege durch die alten Dorfquartiere, wo das Wasser direkt aus den Brunnen in den Gassen sprudelt.',
            },
          },
        ],
      },
      {
        kind: 'table',
        title: { en: 'Two named addresses, one in town, one at 2,400 metres', fr: 'Deux adresses citées, une en ville, une à 2400 mètres', de: 'Zwei genannte Adressen, eine im Ort, eine auf 2400 Metern' },
        items: [
          {
            name: 'Saloon San Jon',
            meta: { en: 'Scuol', fr: 'Scuol', de: 'Scuol' },
            text: {
              en: 'Listed by the tourist office with Graubünden specialities and cowboy-themed dishes matching the saloon, such as grill, smoker fare and the San Jon Burger.',
              fr: 'Répertorié par l’office du tourisme, avec des spécialités grisonnes et des plats à thème cowboy en accord avec le saloon, comme le grill, le fumoir et le San Jon Burger.',
              de: 'Vom Tourismusbüro gelistet, mit Bündner Spezialitäten und Cowboy-Gerichten passend zum Saloon, wie Grill, Smoker-Küche und dem San Jon Burger.',
            },
          },
          {
            name: 'Bar La Palma',
            meta: { en: '2,400 m, in the ski area', fr: '2400 m, dans le domaine skiable', de: '2400 m, im Skigebiet' },
            text: {
              en: 'A restaurant and bar in the ski area at 2,400 m above sea level, listed by the tourist office.',
              fr: 'Un restaurant-bar dans le domaine skiable, à 2400 m d’altitude, répertorié par l’office du tourisme.',
              de: 'Ein Restaurant und Bar im Skigebiet, auf 2400 m über Meer, vom Tourismusbüro gelistet.',
            },
          },
        ],
      },
    ...
    note: {
      en: 'Times, altitudes and figures come from Engadin Scuol Samnaun Val Müstair and Bergbahnen Scuol, checked on 16 September 2026. We publish no ratings and no route descriptions: check conditions on the spot before you set off.',
      fr: 'Durées, altitudes et chiffres viennent d’Engadin Scuol Samnaun Val Müstair et de Bergbahnen Scuol, vérifiés le 16 septembre 2026. Nous ne publions ni notes ni descriptifs d’itinéraires : renseignez-vous sur place avant de partir.',
      de: 'Zeiten, Höhen und Zahlen stammen von Engadin Scuol Samnaun Val Müstair und Bergbahnen Scuol, geprüft am 16. September 2026. Wir veröffentlichen keine Bewertungen und keine Routenbeschreibungen: Erkundigen Sie sich vor Ort, bevor Sie losgehen.',
    },
  },
  faq: [
    {
  ...
  neighbours: ['st-moritz', 'pontresina', 'sils-maria', 'klosters'],
}
