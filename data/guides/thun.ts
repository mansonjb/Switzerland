...
// Sources in data/SOURCES-thun.md (checked 16/09/2026). No number without a source.
export const thun: DestinationGuide = {
  slug: 'thun',
  stamp: 'generic',
  updated: '2026-09-16',
  meta: {
  ...
  title: { en: 'Where to stay in Thun', fr: 'Où dormir à Thoune', de: 'Wo übernachten in Thun' },
  intro: {
    en: 'Thun is home to over 44,000 residents, today the eleventh-largest city in Switzerland by its own count, grown from around 1500 in the 19th century. Countess Elisabeth of Kyburg granted the city its rights in 1264, though the old town, the castle and the city church were already built earlier by the Dukes of Zähringen, whose line ended in 1218 when the Kyburg counts inherited the city. The station is 19 minutes from Bern, 9 minutes from Spiez and 35 minutes from Interlaken Ost, all direct. At the point where the Aare flows out of Lake Thun, stated by the region’s tourist office to be the largest lake in Canton Bern, Thun is not car-free: only the Obere Hauptgasse in the old town is lined with pedestrian arcades.',
    fr: 'Thoune compte plus de 44 000 habitants, « aujourd’hui la onzième plus grande ville de Suisse » selon ses propres chiffres, partie d’environ 1500 habitants au XIXe siècle. La comtesse Élisabeth de Kybourg lui accorda les droits de cité en 1264, même si la vieille ville, le château et l’église de la ville avaient déjà été bâtis plus tôt par les ducs de Zähringen, dont la lignée s’éteignit en 1218 quand les comtes de Kybourg héritèrent de la ville. La gare se trouve à 19 minutes de Berne, 9 minutes de Spiez et 35 minutes d’Interlaken Ost, toutes en direct. Au point où l’Aar sort du lac de Thoune, présenté par l’office du tourisme régional comme le plus grand lac du canton de Berne, Thoune n’est pas sans voiture : seule l’Obere Hauptgasse de la vieille ville est bordée d’arcades piétonnes.',
    de: 'Thun zählt über 44 000 Einwohnende, «heute elftgrösste Stadt der Schweiz» nach eigener Angabe, gewachsen aus rund 1500 Einwohnenden im 19. Jahrhundert. Gräfin Elisabeth von Kyburg erteilte der Stadt 1264 die Stadtrechte, auch wenn Altstadt, Schloss und Stadtkirche schon früher von den Herzögen von Zähringen erbaut worden waren, deren Linie 1218 endete, worauf die Grafen von Kyburg die Stadt erbten. Der Bahnhof liegt 19 Minuten von Bern, 9 Minuten von Spiez und 35 Minuten von Interlaken Ost entfernt, alle direkt. Am Ausfluss der Aare aus dem Thunersee, laut der regionalen Tourismusorganisation dem grössten See im Kanton Bern, ist Thun nicht autofrei: Nur die Obere Hauptgasse in der Altstadt ist mit Lauben für Fussgänger gesäumt.',
  },
  quickAnswer: {
    en: 'Stay in Thun for Schloss Thun and its four towers above the old town, the BLS lake boats leaving from the centre, and a real Swiss city rather than a tourist village. For the widest choice of trains onward to Lauterbrunnen and Grindelwald, sleep in Interlaken instead.',
    fr: 'Dormez à Thoune pour le Château de Thoune et ses quatre tours dominant la vieille ville, les bateaux BLS qui partent du centre, et une vraie ville suisse plutôt qu’un village touristique. Pour le plus large choix de trains vers Lauterbrunnen et Grindelwald, dormez plutôt à Interlaken.',
    de: 'Übernachten Sie in Thun für das Schloss Thun mit seinen vier Türmen über der Altstadt, die BLS-Schiffe, die im Zentrum ablegen, und eine echte Schweizer Stadt statt eines Feriendorfs. Für die grösste Auswahl an Zügen weiter nach Lauterbrunnen und Grindelwald übernachten Sie besser in Interlaken.',
  },
  snapshot: {
    why: {
  ...
  stats: [
    ...
    { value: '1264', label: { en: 'the year Thun received city rights, from Countess Elisabeth of Kyburg', fr: 'l’année d’obtention des droits de cité, accordés par la comtesse Élisabeth de Kybourg', de: 'Erteilung der Stadtrechte durch Gräfin Elisabeth von Kyburg' } },
    { value: '19', label: { en: 'minutes by train from Bern', fr: 'minutes de train depuis Berne', de: 'Zugminuten ab Bern' } },
  ],
  hero: {
    photo: '/photos/thun.jpg',
    caption: { en: 'Schloss Thun and its four towers rising above the old town roofs.', fr: 'Le Château de Thoune et ses quatre tours dominant les toits de la vieille ville.', de: 'Das Schloss Thun mit seinen vier Türmen über den Dächern der Altstadt.' },
    credit: { author: 'Zairon', license: 'CC BY-SA 4.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0/', source: 'https://commons.wikimedia.org/wiki/File:Thun_Altstadt_03.JPG' },
  },
  sectors: [
    {
      title: { en: 'The Old Town, Obere Hauptgasse and Schlossberg', fr: 'La vieille ville, Obere Hauptgasse et Schlossberg', de: 'Altstadt, Obere Hauptgasse und Schlossberg' },
      walk: { en: 'Below Schloss Thun, the historic Läuben', fr: 'Sous le Château de Thoune, les Läuben historiques', de: 'Unterhalb des Schlosses Thun, die historischen Lauben' },
      text: {
        en: 'The historic centre below Schloss Thun, known for its Läuben: two-storey shop rows with elevated walkways above. Hotel Krone stands at Obere Hauptgasse 2, next to the Aare and Thun Castle, and Hotel Restaurant Rathaus sits near the Rathausplatz.',
        fr: 'Le centre historique sous le Château de Thoune, connu pour ses Läuben : des arcades commerçantes à deux niveaux, avec des trottoirs surélevés au-dessus. L’Hôtel Krone se trouve à l’Obere Hauptgasse 2, près de l’Aar et du château, et l’Hôtel Restaurant Rathaus se tient près de la Rathausplatz.',
        de: 'Das historische Zentrum unterhalb des Schlosses Thun, bekannt für seine Lauben: beidseitig hervorspringende untere Geschosse mit darüberliegenden Trottoirs. Das Hotel Krone liegt an der Obere Hauptgasse 2, neben der Aare und dem Schloss, und das Hotel Restaurant Rathaus liegt nahe der Rathausplatz.',
      },
      points: [
    ...
    },
    {
      ...
      walk: { en: 'A short walk from the old town', fr: 'À deux pas de la vieille ville', de: 'Kurzer Weg von der Altstadt' },
      text: {
        en: 'Around the railway station, a short walk from the old town. Hotel Aare stands 5 minutes on foot from Thun station, and Hotel Emmental has been a guesthouse since 1898.',
        fr: 'Autour de la gare, à deux pas de la vieille ville. L’Hôtel Aare se trouve à 5 minutes à pied de la gare de Thoune, et l’Hôtel Emmental est une auberge depuis 1898.',
        de: 'Rund um den Bahnhof, kurzer Weg von der Altstadt. Das Hotel Aare liegt 5 Gehminuten vom Bahnhof Thun entfernt, und das Hotel Emmental ist ein Gasthaus seit 1898.',
      },
      points: [
    ...
    },
    {
      ...
      walk: { en: 'The lake and Schadau Park', fr: 'Le lac et le Schadaupark', de: 'Der See und der Schadaupark' },
      text: {
        en: 'Along the Aarequai and Seestrasse towards Schadau Park and the lake, about 15 minutes on foot from the old town. Hotel Seepark stands directly on Lake Thun within the historic Schadau Park, and Schloss Schadau, built in 1846, is now also a small boutique hotel.',
        fr: 'Le long de l’Aarequai et de la Seestrasse vers le Schadaupark et le lac, à environ 15 minutes à pied de la vieille ville. L’Hôtel Seepark se dresse directement sur le lac de Thoune, au sein du Schadaupark historique, et le Schloss Schadau, bâti en 1846, est aujourd’hui aussi un petit hôtel-boutique.',
        de: 'Entlang des Aarequais und der Seestrasse Richtung Schadaupark und See, rund 15 Gehminuten von der Altstadt entfernt. Das Hotel Seepark liegt direkt am Thunersee im historischen Schadaupark, und das Schloss Schadau, 1846 erbaut, ist heute auch ein kleines Boutique-Hotel.',
      },
      points: [
  ...
  hotelsNote: {
    en: 'Facts taken from the regional Lake Thun tourism listing (brienzersee.ch) on 16 September 2026. No ratings or reviews on this guide.',
    fr: 'Faits relevés sur le portail touristique régional du lac de Thoune (brienzersee.ch) le 16 septembre 2026. Aucune note ni aucun avis sur ce guide.',
    de: 'Fakten vom regionalen Tourismusportal des Thunersees (brienzersee.ch), Stand 16. September 2026. Keine Bewertungen oder Rezensionen.',
  },
  calendar: {
    title: { en: 'What runs, month by month', fr: 'Ce qui fonctionne, mois par mois', de: 'Was geöffnet ist, Monat für Monat' },
    rows: [
      { name: { en: 'Schloss Thun museum', fr: 'Musée du Château de Thoune', de: 'Museum Schloss Thun' }, months: ['r', 'o', 'o', 'o', 'o', 'o', 'o', 'o', 'o', 'o', 'r', 'r'] },
      { name: { en: 'Thun-Panorama', fr: 'Thun-Panorama', de: 'Thun-Panorama' }, months: ['x', 'x', 'o', 'o', 'o', 'o', 'o', 'o', 'o', 'o', 'o', 'x'] },
      { name: { en: 'BLS boats on Lake Thun', fr: 'Bateaux BLS sur le lac de Thoune', de: 'BLS-Schiffe auf dem Thunersee' }, months: ['o', 'o', 'o', 'o', 'o', 'o', 'o', 'o', 'o', 'o', 'o', 'o'] },
    ],
    note: {
      en: '2026. Schloss Thun: February-March daily 13:00-16:00, April-June daily 10:00-17:00, July-August daily 09:30-17:30, September-October daily 10:00-17:00, November-January Sundays only 13:00-16:00, with a daily exception 25 December to 10 January, same hours. Thun-Panorama: March to November, Tuesday to Sunday, 11:00 to 17:00. BLS lake navigation runs year round with a seasonal timetable. Sources: thunersee.ch (Schloss Thun, Thun-Panorama, BLS Schifffahrt pages), checked 16 September 2026.',
      fr: '2026. Château de Thoune : février-mars tous les jours de 13h00 à 16h00, avril-juin tous les jours de 10h00 à 17h00, juillet-août tous les jours de 09h30 à 17h30, septembre-octobre tous les jours de 10h00 à 17h00, novembre-janvier uniquement le dimanche de 13h00 à 16h00, avec une exception quotidienne du 25 décembre au 10 janvier, aux mêmes horaires. Thun-Panorama : de mars à novembre, du mardi au dimanche, de 11h00 à 17h00. La navigation BLS sur le lac fonctionne toute l’année avec un horaire saisonnier. Sources : thunersee.ch (pages Schloss Thun, Thun-Panorama, BLS Schifffahrt), vérifiées le 16 septembre 2026.',
      de: '2026. Schloss Thun: Februar-März täglich 13.00-16.00 Uhr, April-Juni täglich 10.00-17.00 Uhr, Juli-August täglich 09.30-17.30 Uhr, September-Oktober täglich 10.00-17.00 Uhr, November-Januar nur sonntags 13.00-16.00 Uhr, mit einer täglichen Ausnahme vom 25. Dezember bis 10. Januar, gleiche Zeiten. Thun-Panorama: März bis November, Dienstag bis Sonntag, 11.00 bis 17.00 Uhr. Die BLS-Schifffahrt auf dem See läuft ganzjährig mit saisonalem Fahrplan. Quellen: thunersee.ch (Seiten Schloss Thun, Thun-Panorama, BLS Schifffahrt), geprüft am 16. September 2026.',
    },
  },
  practical: {
    title: { en: 'Getting around Thun, in practice', fr: 'Se déplacer à Thoune, en pratique', de: 'Unterwegs in Thun, in der Praxis' },
    items: [
      {
      ...
      {
        title: { en: 'The Läuben of the Old Town', fr: 'Les Läuben de la vieille ville', de: 'Die Lauben der Altstadt' },
        text: {
          en: 'The Obere Hauptgasse below the castle carries two-storey shop rows with elevated walkways above, the town’s distinctive Läuben. It is the only pedestrian-arcaded stretch: Thun as a whole is not car-free.',
          fr: 'L’Obere Hauptgasse, sous le château, porte des arcades commerçantes à deux niveaux avec des trottoirs surélevés au-dessus, les Läuben caractéristiques de la ville. C’est le seul tronçon à arcades piétonnes : Thoune dans son ensemble n’est pas sans voiture.',
          de: 'Die Obere Hauptgasse unterhalb des Schlosses trägt beidseitig hervorspringende untere Geschosse mit darüberliegenden Trottoirs, die charakteristischen Lauben der Stadt. Es ist der einzige Abschnitt mit Fussgängerarkaden: Thun als Ganzes ist nicht autofrei.',
        },
      },
      {
        title: { en: 'Boats on Lake Thun', fr: 'Bateaux sur le lac de Thoune', de: 'Schiffe auf dem Thunersee' },
        text: {
          en: 'BLS operates year-round lake navigation, with seasonal timetables at bls-schiff.ch. Single, half-day and full-day excursion tickets are sold at tourist offices, ship stations or on board, and the historic paddle steamer Blümlisalp is a particular attraction.',
          fr: 'BLS assure une navigation lacustre toute l’année, avec des horaires saisonniers sur bls-schiff.ch. Billets simples, de demi-journée et de journée sont vendus aux offices du tourisme, aux embarcadères ou à bord, et le bateau à aubes historique Blümlisalp est une attraction à part.',
          de: 'BLS betreibt die Schifffahrt auf dem See ganzjährig, mit saisonalen Fahrplänen auf bls-schiff.ch. Einzel-, Halbtages- und Tagesausflugsbillette gibt es bei den Tourismusbüros, an den Schiffsstationen oder an Bord, und der historische Raddampfer Blümlisalp gilt als besondere Attraktion.',
        },
      },
      {
        title: { en: 'No published pass coverage', fr: 'Aucune couverture de pass publiée', de: 'Keine veröffentlichte Pass-Abdeckung' },
        text: {
          en: 'Neither BLS nor the Lake Thun tourist office states exact Swiss Travel Pass coverage for the lake boats on the pages checked. Confirm directly on bls.ch or bls-schiff.ch before assuming a discount.',
          fr: 'Ni BLS ni l’office du tourisme du lac de Thoune n’indiquent de couverture précise par le Swiss Travel Pass pour les bateaux du lac sur les pages vérifiées. À confirmer directement sur bls.ch ou bls-schiff.ch avant de présumer d’une réduction.',
          de: 'Weder BLS noch das Tourismusbüro des Thunersees nennen auf den geprüften Seiten eine genaue Swiss-Travel-Pass-Abdeckung für die Kursschiffe. Direkt auf bls.ch oder bls-schiff.ch bestätigen lassen, bevor man von einer Ermässigung ausgeht.',
        },
      },
    ],
  },
  seasons: {
    summer: {
      ...
      facts: [
        ...
        { value: '11:00 → 17:00', label: { en: 'Thun-Panorama, March to November, Tuesday to Sunday', fr: 'Thun-Panorama, de mars à novembre, du mardi au dimanche', de: 'Thun-Panorama, März bis November, Dienstag bis Sonntag' } },
        { value: '38', label: { en: 'm, the circumference of the Thun-Panorama painting', fr: 'm, la circonférence du tableau du Thun-Panorama', de: 'm Lauflänge des Thun-Panorama-Gemäldes' } },
      ],
      note: {
        en: 'Sources: thunersee.ch (Schloss Thun, Thun-Panorama pages), checked 16 September 2026.',
        fr: 'Sources : thunersee.ch (pages Schloss Thun, Thun-Panorama), vérifiées le 16 septembre 2026.',
        de: 'Quellen: thunersee.ch (Seiten Schloss Thun, Thun-Panorama), geprüft am 16. September 2026.',
      },
    },
    winter: {
      ...
      facts: [
        ...
        { value: '25.12 → 10.1', label: { en: 'Schloss Thun open daily over the festive period, same hours', fr: 'Château de Thoune ouvert tous les jours sur la période des fêtes, mêmes horaires', de: 'Schloss Thun über die Festtage täglich offen, gleiche Öffnungszeiten' } },
        { value: 'Dec → Feb', label: { en: 'months the Thun-Panorama is closed', fr: 'mois de fermeture du Thun-Panorama', de: 'Monate, in denen das Thun-Panorama geschlossen ist' } },
      ],
      note: {
        en: 'Sources: thunersee.ch (Schloss Thun, Thun-Panorama pages), checked 16 September 2026.',
        fr: 'Sources : thunersee.ch (pages Schloss Thun, Thun-Panorama), vérifiées le 16 septembre 2026.',
  ...
  doing: {
    ...
    groups: [
      {
        kind: 'ride',
        title: { en: 'The castle and the lake boats', fr: 'Le château et les bateaux du lac', de: 'Schloss und Kursschiffe' },
        items: [
          {
            name: 'Schloss Thun',
            meta: { en: 'built from the 12th century · four white towers', fr: 'bâti dès le XIIe siècle · quatre tours blanches', de: 'erbaut ab dem 12. Jahrhundert · vier weisse Türme' },
            text: {
              en: 'Built from the 12th century by the Dukes of Zähringen, with four white towers visible from afar. Inside, the high-medieval knights’ hall and a castle museum are open, with audio guides in German, English, French, Italian or Chinese.',
              fr: 'Bâti dès le XIIe siècle par les ducs de Zähringen, avec quatre tours blanches visibles de loin. À l’intérieur, la salle des chevaliers du haut Moyen Âge et un musée du château sont ouverts, avec des audioguides en allemand, anglais, français, italien ou chinois.',
              de: 'Erbaut ab dem 12. Jahrhundert von den Herzögen von Zähringen, mit vier weithin sichtbaren weissen Türmen. Im Innern sind der hochmittelalterliche Rittersaal und ein Schlossmuseum zugänglich, mit Audioguides auf Deutsch, Englisch, Französisch, Italienisch oder Chinesisch.',
            },
          },
          {
            name: { en: 'BLS boat on Lake Thun', fr: 'Bateau BLS sur le lac de Thoune', de: 'BLS-Schiff auf dem Thunersee' },
            meta: { en: 'year round · paddle steamer Blümlisalp', fr: 'toute l’année · bateau à aubes Blümlisalp', de: 'ganzjährig · Raddampfer Blümlisalp' },
            text: {
              en: 'Boats leave Thun for the rest of the lake year round, including the historic paddle steamer Blümlisalp, with an on-board restaurant. Single, half-day and full-day tickets are sold at tourist offices, ship stations or on board.',
              fr: 'Les bateaux partent de Thoune pour le reste du lac toute l’année, dont le bateau à aubes historique Blümlisalp, avec restaurant à bord. Billets simples, de demi-journée et de journée sont vendus aux offices du tourisme, aux embarcadères ou à bord.',
              de: 'Die Schiffe legen ganzjährig ab Thun zum übrigen See ab, darunter der historische Raddampfer Blümlisalp mit Bordrestaurant. Einzel-, Halbtages- und Tagesbillette gibt es bei den Tourismusbüros, an den Schiffsstationen oder an Bord.',
            },
          },
        ],
      },
      {
        kind: 'local',
        title: { en: 'The panorama and Schadau Park', fr: 'Le panorama et le Schadaupark', de: 'Panorama und Schadaupark' },
        items: [
          {
            name: 'Thun-Panorama',
            meta: { en: 'painted 1814 · 38 m circumference', fr: 'peint en 1814 · 38 m de circonférence', de: 'gemalt 1814 · 38 m Lauflänge' },
            text: {
              en: 'Painted by Marquard Wocher in 1814, 38 metres in circumference, described by the tourist office as the oldest still-preserved panorama painting in the world. Open March to November, Tuesday to Sunday, 11:00 to 17:00.',
              fr: 'Peint par Marquard Wocher en 1814, 38 mètres de circonférence, décrit par l’office du tourisme comme le plus ancien panorama peint encore conservé au monde. Ouvert de mars à novembre, du mardi au dimanche, de 11h00 à 17h00.',
              de: 'Gemalt von Marquard Wocher im Jahr 1814, 38 m Lauflänge, vom Tourismusbüro als das älteste noch erhaltene Rundbild der Welt bezeichnet. Geöffnet von März bis November, Dienstag bis Sonntag, 11.00 bis 17.00 Uhr.',
            },
          },
          {
            name: 'Schloss Schadau',
            meta: { en: 'built 1846 · inside Schadau Park', fr: 'construit en 1846 · dans le Schadaupark', de: 'erbaut 1846 · im Schadaupark' },
            text: {
              en: 'A neo-gothic castle built in 1846, set within the English-style Schadau Park directly on the lake, ranked by the tourist office among the architecturally most significant and beautiful castles in Switzerland.',
              fr: 'Un château néogothique construit en 1846, posé dans le Schadaupark à l’anglaise, directement sur le lac, classé par l’office du tourisme parmi les châteaux les plus remarquables et les plus beaux de Suisse sur le plan architectural.',
              de: 'Ein neugotisches Schloss, 1846 erbaut, inmitten des englischen Schadauparks direkt am See, vom Tourismusbüro zu den architektonisch bedeutendsten und schönsten Schlössern der Schweiz gezählt.',
            },
          },
        ],
      },
      {
        kind: 'walk',
        title: { en: 'Along the Aare and the lake', fr: 'Le long de l’Aar et du lac', de: 'Entlang der Aare und des Sees' },
        items: [
          {
    ...
    note: {
      en: 'Places, hours and figures come from the city of Thun and the Lake Thun tourist office, checked on 16 September 2026. We publish no ratings and no route descriptions: check conditions on the spot before you set off.',
      fr: 'Lieux, horaires et chiffres viennent de la ville de Thoune et de l’office du tourisme du lac de Thoune, vérifiés le 16 septembre 2026. Nous ne publions ni notes ni descriptifs d’itinéraires : renseignez-vous sur place avant de partir.',
      de: 'Orte, Zeiten und Zahlen stammen von der Stadt Thun und dem Tourismusbüro des Thunersees, geprüft am 16. September 2026. Wir veröffentlichen keine Bewertungen und keine Routenbeschreibungen: Erkundigen Sie sich vor Ort, bevor Sie losgehen.',
    },
  },
  faq: [
    {
    ...
    {
      q: { en: 'What is the Thun-Panorama?', fr: 'Qu’est-ce que le Thun-Panorama ?', de: 'Was ist das Thun-Panorama?' },
      a: {
        en: 'A cylindrical painting of the town and its Alpine surroundings, painted by Marquard Wocher in 1814, 38 metres in circumference, described by the tourist office as the oldest still-preserved panorama painting in the world.',
        fr: 'Une peinture circulaire de la ville et de son cadre alpin, peinte par Marquard Wocher en 1814, de 38 mètres de circonférence, décrite par l’office du tourisme comme le plus ancien panorama peint encore conservé au monde.',
        de: 'Ein zylindrisches Gemälde der Stadt und ihrer Alpenkulisse, gemalt von Marquard Wocher im Jahr 1814, 38 Meter Lauflänge, vom Tourismusbüro als das älteste noch erhaltene Rundbild der Welt bezeichnet.',
      },
    },
    {
  ...
  neighbours: ['bern', 'spiez', 'interlaken', 'gstaad'],
}
