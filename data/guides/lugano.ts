...
// Sources in data/SOURCES-lugano.md (checked 16/09/2026). No number without a source.
export const lugano: DestinationGuide = {
  slug: 'lugano',
  stamp: 'generic',
  updated: '2026-09-16',
  meta: {
  ...
  title: { en: 'Where to stay in Lugano', fr: 'Où dormir à Lugano', de: 'Wo übernachten in Lugano' },
  intro: {
    en: 'A lake city of 68 633 residents of 141 different nationalities, spread across 21 quartieri after mergers carried out between 2004 and 2013, and Switzerland’s second-largest city by area at 75.8 km2. The municipality’s territory rises from lake level at 273 m to 2116 m, and a community here was first documented in the year 875. After the Gotthard railway opened in 1882, the population grew from 6949 to 14 998 within thirty years. Lugano is reached from Zurich in 1 h 53 direct through the Gotthard Base Tunnel, from Bellinzona in 14 minutes, and from Milan in 1 h 19 direct.',
    fr: 'Une ville lacustre de 68 633 habitants de 141 nationalités différentes, répartie en 21 quartiers après les fusions menées entre 2004 et 2013, et la deuxième ville suisse par sa superficie, avec 75,8 km2. Le territoire de la commune s’élève du niveau du lac, à 273 m, jusqu’à 2116 m, et une communauté y est attestée pour la première fois en l’an 875. Après l’ouverture de la ligne du Gothard en 1882, la population est passée de 6949 à 14 998 habitants en trente ans. Lugano se rejoint depuis Zurich en 1 h 53 en direct par le tunnel de base du Gothard, depuis Bellinzone en 14 minutes, et depuis Milan en 1 h 19 en direct.',
    de: 'Eine Seestadt mit 68 633 Einwohnerinnen und Einwohnern aus 141 verschiedenen Nationen, aufgeteilt in 21 Quartiere nach den zwischen 2004 und 2013 durchgeführten Fusionen, und flächenmässig die zweitgrösste Stadt der Schweiz mit 75,8 km2. Das Gemeindegebiet reicht vom Seespiegel auf 273 m bis auf 2116 m, und eine Siedlung ist hier erstmals im Jahr 875 belegt. Nach der Eröffnung der Gotthardbahn 1882 wuchs die Bevölkerung innert dreissig Jahren von 6949 auf 14 998. Lugano erreicht man ab Zürich in 1 Std. 53 direkt durch den Gotthard-Basistunnel, ab Bellinzona in 14 Minuten, und ab Mailand in 1 Std. 19 direkt.',
  },
  quickAnswer: {
    en: 'Stay in Lugano for a bigger city with its own direct train station, a historic pedestrian centre, and two different mountain funiculars, to Monte San Salvatore and to Monte Bré. For a smaller, quieter base on Lake Maggiore instead, stay in Locarno or Ascona.',
    fr: 'Dormez à Lugano pour une ville plus grande, avec sa propre gare directe, un centre historique piéton, et deux funiculaires de montagne différents, vers le Monte San Salvatore et vers le Monte Bré. Pour une base plus petite et plus calme sur le lac Majeur, dormez plutôt à Locarno ou à Ascona.',
    de: 'Übernachten Sie in Lugano für eine grössere Stadt mit eigenem direktem Bahnhof, einem historischen Fussgängerzentrum und zwei verschiedenen Bergbahnen, auf den Monte San Salvatore und auf den Monte Bré. Für eine kleinere, ruhigere Basis am Lago Maggiore übernachten Sie stattdessen in Locarno oder Ascona.',
  },
  snapshot: {
    why: {
  ...
  stats: [
    ...
    { value: '912', label: { en: 'metres, the summit of Monte San Salvatore, reached by funicular in 12 minutes', fr: 'mètres, le sommet du Monte San Salvatore, atteint en funiculaire en 12 minutes', de: 'Meter, der Gipfel des Monte San Salvatore, mit der Standseilbahn in 12 Minuten erreicht' } },
    { value: '1 h 53', label: { en: 'direct train from Zurich, via the Gotthard Base Tunnel', fr: 'en train direct depuis Zurich, via le tunnel de base du Gothard', de: 'direkte Zugfahrt ab Zürich, über den Gotthard-Basistunnel' } },
  ],
  hero: {
    photo: '/photos/lugano.jpg',
    caption: { en: 'Lugano and Lake Lugano, seen from Monte Sighignola.', fr: 'Lugano et le lac de Lugano, vus depuis le Monte Sighignola.', de: 'Lugano und der Luganersee, vom Monte Sighignola aus gesehen.' },
  ...
  sectors: [
    {
      title: { en: 'Historic centre and lakefront', fr: 'Centre historique et front de lac', de: 'Altstadt und Seeufer' },
      walk: { en: 'Via Nassa, Piazza Luini', fr: 'Via Nassa, Piazza Luini', de: 'Via Nassa, Piazza Luini' },
      text: {
        en: 'The pedestrianised old town and lakeside promenade. International au Lac Historic Lakeside Hotel stands at Via Nassa 68, opposite Piazza Luini, and Hotel Walter au Lac has stood on Piazza Rezzonico since 1888, run by the Cereda family for four generations.',
        fr: 'La vieille ville piétonne et la promenade au bord du lac. L’International au Lac Historic Lakeside Hotel se trouve à la Via Nassa 68, face à la Piazza Luini, et l’Hôtel Walter au Lac occupe la Piazza Rezzonico depuis 1888, tenu par la famille Cereda sur quatre générations.',
        de: 'Die autofreie Altstadt und die Seepromenade. Das International au Lac Historic Lakeside Hotel liegt an der Via Nassa 68, gegenüber der Piazza Luini, und das Hotel Walter au Lac steht seit 1888 an der Piazza Rezzonico, seit vier Generationen von der Familie Cereda geführt.',
      },
      points: [
    ...
    },
    {
      ...
      walk: { en: 'Riva Caccia, toward Paradiso', fr: 'Riva Caccia, vers Paradiso', de: 'Riva Caccia, Richtung Paradiso' },
      text: {
        en: 'The lakefront stretch toward Paradiso and the valley station of the Monte San Salvatore funicular. Hotel Splendide Royal, a Belle Époque palace at Riva Caccia 7, faces the lake directly, with 93 rooms and 176 beds.',
        fr: 'La section du front de lac vers Paradiso et la station de départ du funiculaire du Monte San Salvatore. L’Hôtel Splendide Royal, palace Belle Époque au Riva Caccia 7, fait face directement au lac, avec 93 chambres et 176 lits.',
        de: 'Der Seeuferabschnitt Richtung Paradiso und die Talstation der Monte-San-Salvatore-Bahn. Das Hotel Splendide Royal, ein Belle-Époque-Palast an der Riva Caccia 7, liegt direkt am See, mit 93 Zimmern und 176 Betten.',
      },
      points: [
    ...
    },
    {
      ...
      walk: { en: 'Via Paolo Regazzoni, Via Montalbano', fr: 'Via Paolo Regazzoni, Via Montalbano', de: 'Via Paolo Regazzoni, Via Montalbano' },
      text: {
        en: 'The area around Lugano station, linked to the lake by the city funicular, and the residential hillside above. Hotel Federale Lugano, family-run since 1923, is 3 minutes on foot from the station, and Villa Principe Leopoldo sits higher on the hill at Via Montalbano 5A.',
        fr: 'Le quartier de la gare de Lugano, relié au lac par le funiculaire urbain, et le coteau résidentiel au-dessus. L’Hôtel Federale Lugano, en mains familiales depuis 1923, se trouve à 3 minutes à pied de la gare, et la Villa Principe Leopoldo se dresse plus haut sur le coteau, à la Via Montalbano 5A.',
        de: 'Das Quartier rund um den Bahnhof Lugano, mit der Standseilbahn zum See verbunden, und der Wohnhang darüber. Das seit 1923 familiengeführte Hotel Federale Lugano liegt 3 Gehminuten vom Bahnhof entfernt, und die Villa Principe Leopoldo steht weiter oben am Hang, an der Via Montalbano 5A.',
      },
      points: [
  ...
  hotelsNote: {
    en: 'Facts taken from each hotel’s listing on the Lugano tourist office site on 16 September 2026. No ratings or reviews on this guide.',
    fr: 'Faits relevés sur la fiche de chaque hôtel sur le site de l’office du tourisme de Lugano le 16 septembre 2026. Aucune note ni aucun avis sur ce guide.',
    de: 'Fakten vom Eintrag des jeweiligen Hotels auf der Website des Tourismusbüros Lugano, Stand 16. September 2026. Keine Bewertungen oder Rezensionen.',
  },
  calendar: {
    title: { en: 'What is open, month by month', fr: 'Ce qui est ouvert, mois par mois', de: 'Was geöffnet ist, Monat für Monat' },
    rows: [
      { name: { en: 'Monte San Salvatore funicular', fr: 'Funiculaire du Monte San Salvatore', de: 'Standseilbahn Monte San Salvatore' }, months: ['x', 'x', 'r', 'o', 'o', 'o', 'o', 'o', 'o', 'o', 'r', 'x'] },
  ...
  practical: {
    title: { en: 'Lugano, in practice', fr: 'Lugano, en pratique', de: 'Lugano, in der Praxis' },
    items: [
      {
  ...
  seasons: {
    summer: {
      title: { en: 'Summer in Lugano', fr: 'L’été à Lugano', de: 'Sommer in Lugano' },
      base: {
        en: 'Both funiculars run their full timetable, Monte San Salvatore’s panoramic cars reach the summit in 12 minutes with services running from morning to evening, and the last summer departure is at 22:30: the historic centre and Riva Caccia, close to both valley stations, are the practical base.',
        fr: 'Les deux funiculaires circulent selon l’horaire complet, les voitures panoramiques du Monte San Salvatore atteignent le sommet en 12 minutes avec un service du matin au soir, et le dernier départ estival a lieu à 22h30 : le centre historique et la Riva Caccia, proches des deux stations de départ, sont la base pratique.',
        de: 'Beide Bergbahnen fahren nach vollem Fahrplan, die Panoramawagen des Monte San Salvatore erreichen den Gipfel in 12 Minuten mit Betrieb von morgens bis abends, und die letzte Sommerfahrt ist um 22:30 Uhr: das historische Zentrum und die Riva Caccia, nahe an beiden Talstationen, sind die praktische Basis.',
      },
      facts: [
        { value: '12 min', label: { en: 'ride to the summit of Monte San Salvatore, panoramic cars', fr: 'trajet jusqu’au sommet du Monte San Salvatore, voitures panoramiques', de: 'Fahrt zum Gipfel des Monte San Salvatore, Panoramawagen' } },
        { value: '22:30', label: { en: 'last summer departure of the Monte San Salvatore funicular', fr: 'dernier départ estival du funiculaire du Monte San Salvatore', de: 'letzte Sommerfahrt der Standseilbahn Monte San Salvatore' } },
      ],
      note: {
        en: 'Sources: montesansalvatore.ch, checked 16 September 2026.',
        fr: 'Sources : montesansalvatore.ch, vérifiées le 16 septembre 2026.',
        de: 'Quellen: montesansalvatore.ch, geprüft am 16. September 2026.',
      },
    },
    winter: {
      ...
      note: {
        ...
        fr: 'Sources : montesansalvatore.ch, montebre.ch, vérifiées le 16 septembre 2026.',
        de: 'Quellen: montesansalvatore.ch, montebre.ch, geprüft am 16. September 2026.',
      },
    },
  },
  doing: {
    ...
    groups: [
      {
        kind: 'walk',
        title: { en: 'Two named walks', fr: 'Deux promenades nommées', de: 'Zwei benannte Spaziergänge' },
        items: [
          {
            name: { en: 'Belvedere Garden to Parco Ciani', fr: 'Du Giardino Belvedere au Parco Ciani', de: 'Vom Giardino Belvedere zum Parco Ciani' },
            meta: { en: 'lungolago · 11 000 m2 then 63 000 m2', fr: 'lungolago · 11 000 m2 puis 63 000 m2', de: 'Lungolago · 11 000 m2, dann 63 000 m2' },
            text: {
              en: 'The Belvedere Garden covers 11 000 m2 along the promenade, with a double row of trees and what the tourist office calls the city’s most imposing tree, a giant sequoia. It leads to Parco Ciani, 63 000 m2 divided between a formal garden near Villa Ciani and a more natural area of oaks, lindens, plane trees and maples reaching the Cassarate river.',
              fr: 'Le Giardino Belvedere s’étend sur 11 000 m2 le long de la promenade, avec un double alignement d’arbres et ce que l’office du tourisme appelle l’arbre le plus imposant de la ville, un séquoia géant. Il mène au Parco Ciani, 63 000 m2 répartis entre un jardin à la française près de la Villa Ciani et une partie plus naturelle de chênes, tilleuls, platanes et érables, jusqu’à la rivière Cassarate.',
              de: 'Der Giardino Belvedere erstreckt sich auf 11 000 m2 entlang der Promenade, mit einer doppelten Baumreihe und dem, was das Tourismusbüro den imposantesten Baum der Stadt nennt, eine riesige Sequoia. Er führt zum Parco Ciani, 63 000 m2, aufgeteilt in einen gestalteten Garten bei der Villa Ciani und einen naturnäheren Teil mit Eichen, Linden, Platanen und Ahornen bis zum Fluss Cassarate.',
            },
          },
          {
            name: { en: 'Monte Bré to Gandria', fr: 'Du Monte Bré à Gandria', de: 'Vom Monte Bré nach Gandria' },
            meta: { en: '1 h 30 downhill from the summit, 933 m to lake level', fr: '1 h 30 à la descente depuis le sommet, de 933 m au niveau du lac', de: '1 Std. 30 bergab ab dem Gipfel, von 933 m zum Seespiegel' },
            text: {
              en: 'A downhill walk of 1 h 30 starting at the summit of Monte Bré, with 16 m of ascent and 652 m of descent, ending at the lakeside village of Gandria.',
              fr: 'Une descente de 1 h 30 depuis le sommet du Monte Bré, avec 16 m de dénivelé positif et 652 m de dénivelé négatif, jusqu’au village lacustre de Gandria.',
              de: 'Ein 1 Std. 30 langer Abstieg ab dem Gipfel des Monte Bré, mit 16 m Aufstieg und 652 m Abstieg, bis zum Seedorf Gandria.',
            },
          },
        ],
      },
      {
        kind: 'ride',
        title: { en: 'Two mountains, two funiculars', fr: 'Deux montagnes, deux funiculaires', de: 'Zwei Berge, zwei Standseilbahnen' },
        items: [
          {
            name: 'Monte San Salvatore',
            meta: { en: '912 m · 1660 m line, gradients up to 61% · 12 min · in service since 1890', fr: '912 m · ligne de 1660 m, pentes jusqu’à 61 % · 12 min · en service depuis 1890', de: '912 m · 1660 m Streckenlänge, Steigungen bis 61 % · 12 Min. · seit 1890 in Betrieb' },
            text: {
              en: 'Construction began in July 1888 and the line has been in service since 1890, climbing 1660 m of track at gradients of 37 then 61 per cent, its panoramic cars carrying up to 60 passengers plus the conductor to the 912 m summit in 12 minutes.',
              fr: 'La construction a débuté en juillet 1888 et la ligne est en service depuis 1890, gravissant 1660 m de voie avec des pentes de 37 puis 61 %, ses voitures panoramiques transportant jusqu’à 60 passagers plus le conducteur jusqu’au sommet, à 912 m, en 12 minutes.',
              de: 'Der Bau begann im Juli 1888, seit 1890 ist die Bahn in Betrieb, sie überwindet 1660 m Streckenlänge mit Steigungen von 37, dann 61 Prozent, ihre Panoramawagen bringen bis zu 60 Fahrgäste plus Begleitperson in 12 Minuten zum 912 m hohen Gipfel.',
            },
          },
          {
            name: 'Monte Bré',
            meta: { en: '933 m · inaugurated 1908 · departs from Lugano (Cassarate) or Suvigliana', fr: '933 m · inauguré en 1908 · départ de Lugano (Cassarate) ou Suvigliana', de: '933 m · eröffnet 1908 · Abfahrt ab Lugano (Cassarate) oder Suvigliana' },
            text: {
              en: 'Inaugurated in 1908, the funicular to the 933 m summit of Monte Bré is marketed by its operator as part of Lugano’s history for more than 115 years, with an alternative departure stop at Suvigliana.',
              fr: 'Inauguré en 1908, le funiculaire vers le sommet du Monte Bré, à 933 m, se présente auprès de son exploitant comme faisant partie de l’histoire de Lugano depuis plus de 115 ans, avec un arrêt de départ alternatif à Suvigliana.',
              de: 'Die 1908 eröffnete Standseilbahn zum 933 m hohen Gipfel des Monte Bré wird vom Betreiber als seit mehr als 115 Jahren Teil der Geschichte Luganos vermarktet, mit einer alternativen Abfahrtsstation in Suvigliana.',
            },
          },
        ],
      },
      {
        kind: 'local',
        title: { en: 'Two named churches', fr: 'Deux églises nommées', de: 'Zwei benannte Kirchen' },
        items: [
          {
            name: 'Santa Maria degli Angeli',
            meta: { en: 'Piazza Luini 3 · founded 1490, built 1499 · free entry', fr: 'Piazza Luini 3 · fondée en 1490, bâtie en 1499 · entrée libre', de: 'Piazza Luini 3 · gegründet 1490, erbaut 1499 · freier Eintritt' },
            text: {
              en: 'A former Franciscan convent founded in 1490, its church built in 1499, holding what is described as Bernardino Luini’s last work, a large Crucifixion fresco of 1529 to 1532, alongside his 1530 Madonna con Bambino e San Giovannino.',
              fr: 'Un ancien couvent franciscain fondé en 1490, l’église elle-même bâtie en 1499, abritant ce qui est décrit comme la dernière œuvre de Bernardino Luini, une grande fresque de la Crucifixion de 1529 à 1532, ainsi que sa Madonna con Bambino e San Giovannino de 1530.',
              de: 'Ein ehemaliges Franziskanerkloster, gegründet 1490, die Kirche selbst 1499 erbaut, mit dem als letztes Werk Bernardino Luinis beschriebenen grossen Kreuzigungsfresko von 1529 bis 1532, sowie seiner Madonna con Bambino e San Giovannino von 1530.',
            },
          },
          {
            ...
            text: {
              ...
              de: 'Bereits 818 Pfarrkirche, wurde 1078 Kollegiatkirche und erst 1888 zur Kathedrale erhoben. Ihre zwischen 1500 und 1517 vollendete Renaissancefassade gilt als eines der Meisterwerke der lombardischen Renaissance, das achteckige Taufbecken stammt von 1430.',
            },
          },
        ],
      },
      {
        ...
        items: [
          {
            name: 'Ristorante Galleria Arté al Lago',
            meta: { en: 'Rivetta Alfonsina Storni 1, inside Villa Castagnola · Tuesday to Saturday', fr: 'Rivetta Alfonsina Storni 1, au sein de la Villa Castagnola · du mardi au samedi', de: 'Rivetta Alfonsina Storni 1, in der Villa Castagnola · Dienstag bis Samstag' },
            text: {
              en: 'Set inside an art gallery whose exhibitions change twice a year, listed by the tourist office with 16 GaultMillau points and a dress code of evening wear with long trousers.',
              fr: 'Installé dans une galerie d’art dont les expositions changent deux fois par an, répertorié par l’office du tourisme avec 16 points GaultMillau et une tenue de soirée exigée, pantalon long.',
              de: 'In einer Kunstgalerie untergebracht, deren Ausstellungen zweimal jährlich wechseln, vom Tourismusbüro mit 16 GaultMillau-Punkten gelistet, mit Dresscode Abendgarderobe und langer Hose.',
            },
          },
          {
            name: 'Ristorante Luini6',
            meta: { en: 'Via Bernardino Luini 6, near the LAC cultural centre', fr: 'Via Bernardino Luini 6, près du centre culturel LAC', de: 'Via Bernardino Luini 6, beim Kulturzentrum LAC' },
            text: {
              en: 'A central, wheelchair-accessible address with a panoramic view and terrace seating, listed by the tourist office for a bistro-style menu of poke, pinsa and bagels.',
              fr: 'Une adresse centrale et accessible en fauteuil roulant, avec vue panoramique et terrasse, répertoriée par l’office du tourisme pour une carte façon bistrot de poke, pinsa et bagels.',
              de: 'Eine zentrale, rollstuhlgängige Adresse mit Panoramablick und Terrasse, vom Tourismusbüro für eine Bistro-Karte mit Poke, Pinsa und Bagels gelistet.',
            },
          },
        ],
      },
    ...
    note: {
      en: 'Times, fares and figures come from Lugano Region tourism, the Città di Lugano, montesansalvatore.ch and montebre.ch, checked on 16 September 2026. We publish no ratings and no route descriptions: check conditions on the spot before you set off.',
      fr: 'Horaires, tarifs et chiffres proviennent de Lugano Region tourisme, de la Città di Lugano, de montesansalvatore.ch et de montebre.ch, vérifiés le 16 septembre 2026. Nous ne publions ni notes ni descriptifs d’itinéraires : renseignez-vous sur place avant de partir.',
      de: 'Zeiten, Tarife und Zahlen stammen von Lugano Region Tourismus, der Città di Lugano, montesansalvatore.ch und montebre.ch, geprüft am 16. September 2026. Wir veröffentlichen keine Bewertungen und keine Routenbeschreibungen: Erkundigen Sie sich vor Ort, bevor Sie losgehen.',
    },
  },
  faq: [
    {
  ...
  neighbours: ['locarno', 'ascona', 'bellinzona'],
}
