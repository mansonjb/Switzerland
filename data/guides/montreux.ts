...
export const montreux: DestinationGuide = {
  ...
  meta: {
    ...
    description: {
      en: 'Montreux area by area: the lakefront quai and Casino district, the old town on the hill, and Territet toward Chillon. Hotels with real addresses, the Rochers-de-Naye cog railway, and the Montreux Jazz Festival dates.',
      fr: 'Montreux secteur par secteur : le quai et le quartier du Casino, la vieille ville sur la colline, Territet vers Chillon. Hôtels avec adresses réelles, le train à crémaillère des Rochers-de-Naye et les dates du Montreux Jazz Festival.',
      de: 'Montreux Ortsteil für Ortsteil: Seepromenade und Casino-Viertel, die Altstadt auf dem Hügel, Territet Richtung Chillon. Hotels mit echten Adressen, die Rochers-de-Naye-Zahnradbahn und die Termine des Montreux Jazz Festival.',
    },
  },
  ...
  snapshot: {
    why: {
      en: 'The lakefront quai, the Jazz Festival stages and the Rochers-de-Naye cog railway all start from the same station, with Chillon Castle a short ride further along the shore and the GoldenPass Express leaving for Interlaken without a change of train.',
      fr: 'Le quai, les scènes du Jazz Festival et le train à crémaillère des Rochers-de-Naye partent tous de la même gare, avec le château de Chillon à quelques minutes plus loin sur la rive et le GoldenPass Express qui part vers Interlaken sans changement de train.',
      de: 'Die Seepromenade, die Bühnen des Jazz Festival und die Rochers-de-Naye-Zahnradbahn starten alle vom selben Bahnhof, mit dem Schloss Chillon eine kurze Fahrt weiter am Ufer und dem GoldenPass Express, der ohne Umsteigen nach Interlaken fährt.',
    },
    where: {
      en: 'Along the quai from Territet to Clarens and around the Casino for the lakefront, up in the old town around Rue du Temple and Rue du Pont for a quieter base near the station, or towards Territet and Veytaux for Chillon Castle.',
      fr: 'Le long du quai, de Territet à Clarens, et autour du Casino pour le front de lac, en haut de la vieille ville, autour de la Rue du Temple et de la Rue du Pont pour une base plus calme près de la gare, ou vers Territet et Veytaux pour le château de Chillon.',
      de: 'Entlang der Promenade von Territet bis Clarens und rund um das Casino für die Seefront, oben in der Altstadt rund um Rue du Temple und Rue du Pont für eine ruhigere Basis nahe dem Bahnhof, oder Richtung Territet und Veytaux für das Schloss Chillon.',
    },
    watch: {
    ...
    items: [
      {
        ...
        text: {
          en: 'Chillon Castle stands at Avenue de Chillon 21, in Veytaux, on the lake road south of town, reached by train, bus or CGN boat.',
          fr: 'Le château de Chillon se trouve au 21 avenue de Chillon, à Veytaux, sur la route du lac au sud de la ville, accessible en train, en bus ou en bateau CGN.',
          de: 'Das Schloss Chillon steht an der Avenue de Chillon 21, in Veytaux, an der Seestrasse südlich der Stadt, erreichbar mit Zug, Bus oder CGN-Schiff.',
        },
      },
      {
        title: { en: 'By car', fr: 'En voiture', de: 'Mit dem Auto' },
        text: {
          en: 'Montreux is reached by road with no car ban and no access permit; paid town parking sits in the centre, near Rue de Bon-Port and Rue du Théâtre.',
          fr: 'Montreux se rejoint par la route, sans interdiction de circuler ni permis d’accès ; le stationnement payant de la ville se trouve dans le centre, près de la rue de Bon-Port et de la rue du Théâtre.',
          de: 'Montreux ist mit dem Auto erreichbar, ohne Fahrverbot und ohne Zufahrtsbewilligung; das gebührenpflichtige Parkieren der Stadt liegt im Zentrum, nahe der Rue de Bon-Port und der Rue du Théâtre.',
        },
      },
      {
        title: { en: 'The GoldenPass Express', fr: 'Le GoldenPass Express', de: 'Der GoldenPass Express' },
        text: {
          en: 'Launched on 11 December 2022, two return services a day run Montreux to Interlaken in 3 h 15, switching from metre gauge to standard gauge at Zweisimmen with a variable-gauge bogie, without passengers changing trains.',
          fr: 'Mis en service le 11 décembre 2022, deux allers-retours par jour relient Montreux à Interlaken en 3 h 15, en passant de la voie métrique à la voie normale à Zweisimmen grâce à un bogie à écartement variable, sans que les voyageurs changent de train.',
          de: 'Seit dem 11. Dezember 2022 verkehren zwei Hin- und Rückfahrten täglich zwischen Montreux und Interlaken in 3 Std. 15, wobei in Zweisimmen dank eines Rollbocks mit variabler Spurweite von Meter- auf Normalspur gewechselt wird, ohne dass die Reisenden umsteigen.',
        },
      },
      {
        title: { en: 'CGN boats', fr: 'Bateaux CGN', de: 'CGN-Schiffe' },
        text: {
          en: 'CGN boats call at both Montreux and Chillon. The Swiss Travel Pass is valid on all CGN cruises except events, and so are half-fare and GA travelcards.',
          fr: 'Les bateaux de la CGN font escale à Montreux comme à Chillon. Le Swiss Travel Pass est valable sur toutes les croisières CGN, sauf événements, tout comme les abonnements demi-tarif et AG.',
          de: 'Die CGN-Schiffe legen sowohl in Montreux als auch in Chillon an. Der Swiss Travel Pass gilt auf allen CGN-Kreuzfahrten ausser Events, ebenso wie Halbtax- und GA-Abonnemente.',
        },
      },
    ],
  },
  seasons: {
    summer: {
      ...
      base: {
        en: 'With the Montreux Jazz Festival on the lakefront and Chillon open until 19:00, the quai around the Casino is the base for summer, though the Rochers-de-Naye cog railway stops for works from 14 September.',
        fr: 'Avec le Montreux Jazz Festival sur le front de lac et Chillon ouvert jusqu’à 19h00, le quai autour du Casino est la base de l’été, même si le train à crémaillère des Rochers-de-Naye s’arrête pour travaux dès le 14 septembre.',
        de: 'Mit dem Montreux Jazz Festival an der Seepromenade und Chillon bis 19.00 Uhr geöffnet, ist die Promenade rund um das Casino die Basis für den Sommer, auch wenn die Rochers-de-Naye-Zahnradbahn ab dem 14. September wegen Bauarbeiten stillsteht.',
      },
      facts: [
    ...
    winter: {
      ...
      base: {
        en: 'Chillon keeps shorter hours and closes on 1 January and 25 December, the CGN fleet reduces to four boats, and the Rochers-de-Naye line closes again for works from 1 April to 21 May 2027 at the start of the following spring.',
        fr: 'Chillon garde des horaires réduits et ferme le 1er janvier et le 25 décembre, la flotte CGN se réduit à quatre bateaux, et la ligne des Rochers-de-Naye ferme à nouveau pour travaux du 1er avril au 21 mai 2027, au début du printemps suivant.',
        de: 'Chillon hat kürzere Öffnungszeiten und schliesst am 1. Januar und 25. Dezember, die CGN-Flotte reduziert sich auf vier Schiffe, und die Rochers-de-Naye-Linie schliesst zu Beginn des folgenden Frühlings erneut vom 1. April bis 21. Mai 2027 für Bauarbeiten.',
      },
      facts: [
  ...
  doing: {
    ...
    intro: {
      en: 'Not a trail guide: named places and figures from Montreux Riviera tourism, MOB and Chillon Castle, checked on their own pages.',
      fr: 'Pas un guide de randonnée : des lieux et des chiffres nommés, repris de Montreux Riviera, de la MOB et du château de Chillon, vérifiés sur leurs propres pages.',
      de: 'Kein Wanderführer: benannte Orte und Zahlen von Montreux Riviera, der MOB und dem Schloss Chillon, auf deren eigenen Seiten geprüft.',
    },
    groups: [
      {
        kind: 'walk',
        ...
        items: [
          {
            ...
            text: {
              en: 'Published by the Montreux Riviera tourist office itself, the route runs from Lutry to Saint-Saphorin through the Lavaux vineyard terraces, reached from Montreux by train via Vevey.',
              fr: 'Publié par l’office du tourisme Montreux Riviera lui-même, l’itinéraire va de Lutry à Saint-Saphorin à travers les terrasses viticoles de Lavaux, accessible depuis Montreux en train via Vevey.',
              de: 'Vom Tourismusbüro Montreux Riviera selbst veröffentlicht, führt die Route von Lutry nach Saint-Saphorin durch die Weinbergterrassen von Lavaux, ab Montreux mit dem Zug über Vevey erreichbar.',
            },
          },
          {
            ...
            text: {
              en: 'At the summit, the operator lists hiking trails, a via ferrata, the Rambertia alpine botanical garden, and two restaurants, the Buvette de Jaman and the panoramic Plein Roc, open through the summer.',
              fr: 'Au sommet, l’exploitant recense des sentiers de randonnée, une via ferrata, le jardin alpin botanique de la Rambertia, et deux restaurants, la Buvette de Jaman et le panoramique Plein Roc, ouverts durant l’été.',
              de: 'Auf dem Gipfel führt der Betreiber Wanderwege, eine Via Ferrata, den alpinen botanischen Garten Rambertia sowie zwei im Sommer geöffnete Restaurants auf, die Buvette de Jaman und das Panoramarestaurant Plein Roc.',
            },
          },
        ],
      },
        ...
        items: [
          {
            ...
            text: {
              en: 'The line reaches 2042 m from the town’s own station, with the alpine garden, via ferrata and two restaurants waiting at the top in summer.',
              fr: 'La ligne atteint 2042 m depuis la gare même de la ville, avec le jardin alpin, la via ferrata et deux restaurants au sommet en été.',
              de: 'Die Linie erreicht 2042 m ab dem eigenen Bahnhof der Stadt, mit dem Alpengarten, der Via Ferrata und zwei Restaurants im Sommer auf dem Gipfel.',
            },
          },
          {
            ...
            text: {
              en: 'Launched on 11 December 2022, the train uses a variable-gauge bogie to switch from metre gauge to standard gauge at Zweisimmen, without passengers changing trains.',
              fr: 'Mis en service le 11 décembre 2022, le train passe de la voie métrique à la voie normale à Zweisimmen grâce à un bogie à écartement variable, sans que les voyageurs changent de train.',
              de: 'Seit dem 11. Dezember 2022 wechselt der Zug dank eines Rollbocks mit variabler Spurweite in Zweisimmen von Meter- auf Normalspur, ohne dass die Reisenden umsteigen.',
            },
          },
        ],
      },
        ...
        items: [
          {
            ...
            text: {
              en: 'Described by the castle itself as Switzerland’s most visited historical monument, it is reached from Montreux by train, bus or CGN boat along the lake road.',
              fr: 'Présenté par le château lui-même comme le monument historique le plus visité de Suisse, il se rejoint depuis Montreux en train, en bus ou en bateau CGN, le long de la route du lac.',
              de: 'Vom Schloss selbst als meistbesuchtes historisches Baudenkmal der Schweiz bezeichnet, erreicht man es ab Montreux mit Zug, Bus oder CGN-Schiff entlang der Seestrasse.',
            },
          },
          {
            ...
            text: {
              en: 'Founded in 1967 by Claude Nobs, the festival stages rise on and around the lakefront quai each July.',
              fr: 'Fondé en 1967 par Claude Nobs, le festival dresse ses scènes sur le quai et à ses abords chaque mois de juillet.',
              de: 'Das 1967 von Claude Nobs gegründete Festival errichtet seine Bühnen jeden Juli auf und um die Seepromenade.',
            },
          },
        ],
      },
        ...
        items: [
          {
            ...
            text: {
              en: 'Its own site describes a Moorish building on the shore of Lake Geneva, serving the cooking of Iran, Lebanon and Morocco.',
              fr: 'Son propre site décrit un bâtiment mauresque au bord du Léman, avec une cuisine d’Iran, du Liban et du Maroc.',
              de: 'Die eigene Website beschreibt ein maurisches Gebäude am Ufer des Genfersees, mit Küche aus dem Iran, dem Libanon und Marokko.',
            },
          },
          {
            name: 'Brasserie J5',
            ...
            text: {
              en: 'On the lake, the restaurant publishes continuous service from midday to 22:00 and a seasonal market-based menu, with booking advised.',
              fr: 'Au bord du lac, le restaurant annonce un service continu de midi à 22h00 et une carte de saison inspirée du marché, réservation conseillée.',
              de: 'Am See wirbt das Restaurant mit durchgehendem Service von mittags bis 22.00 Uhr und einer saisonalen, marktinspirierten Karte, Reservierung empfohlen.',
            },
          },
        ],
      },
  ...
  faq: [
    {
      ...
      a: {
        en: '1 h 14 direct on the IR 90, or 1 h 22 direct on the IR 95. No change is needed.',
        fr: '1 h 14 en IR 90 direct, ou 1 h 22 en IR 95 direct. Aucun changement n’est nécessaire.',
        de: '1 Std. 14 mit dem direkten IR 90, oder 1 Std. 22 mit dem direkten IR 95. Kein Umsteigen nötig.',
      },
    },
    {
      ...
      a: {
        en: '2 to 17 July 2027, the 61st edition. The festival was founded in 1967 by Claude Nobs.',
        fr: 'Du 2 au 17 juillet 2027, pour la 61e édition. Le festival a été fondé en 1967 par Claude Nobs.',
        de: 'Vom 2. bis 17. Juli 2027, zur 61. Ausgabe. Das Festival wurde 1967 von Claude Nobs gegründet.',
      },
    },
    {
      q: { en: 'Is Chillon Castle in Montreux?', fr: 'Le château de Chillon est-il à Montreux ?', de: 'Liegt das Schloss Chillon in Montreux?' },
      a: {
        en: 'It stands at Avenue de Chillon 21, in Veytaux, at the southern end of the Montreux Riviera, reached by train, bus or CGN boat. Adults pay CHF 15, or nothing with a Swiss Travel Pass carrying the Swiss Museum Pass option.',
        fr: 'Il se trouve au 21 avenue de Chillon, à Veytaux, à l’extrémité sud de la Riviera montreusienne, accessible en train, en bus ou en bateau CGN. Les adultes paient 15 CHF, ou rien avec un Swiss Travel Pass incluant l’option Swiss Museum Pass.',
        de: 'Es steht an der Avenue de Chillon 21, in Veytaux, am südlichen Ende der Montreux Riviera, erreichbar mit Zug, Bus oder CGN-Schiff. Erwachsene zahlen CHF 15, oder nichts mit einem Swiss Travel Pass mit der Option Swiss Museum Pass.',
      },
    },
    {
      q: { en: 'Can I go up the Rochers-de-Naye?', fr: 'Peut-on monter aux Rochers-de-Naye ?', de: 'Kann man auf die Rochers-de-Naye fahren?' },
      a: {
        en: 'The cog railway reaches 2042 m in 55 minutes from Montreux, but the line is closed for works from 14 September to 17 October 2026 and again from 1 April to 21 May 2027.',
        fr: 'Le train à crémaillère atteint 2042 m en 55 minutes depuis Montreux, mais la ligne est fermée pour travaux du 14 septembre au 17 octobre 2026, puis à nouveau du 1er avril au 21 mai 2027.',
        de: 'Die Zahnradbahn erreicht ab Montreux in 55 Minuten 2042 m, aber die Linie ist vom 14. September bis 17. Oktober 2026 und erneut vom 1. April bis 21. Mai 2027 wegen Bauarbeiten geschlossen.',
      },
    },
    {
      ...
      a: {
        en: 'Yes. The GoldenPass Express runs Montreux to Interlaken in 3 h 15 with no change, using a variable-gauge bogie at Zweisimmen. It started on 11 December 2022 and runs twice each way a day.',
        fr: 'Oui. Le GoldenPass Express relie Montreux à Interlaken en 3 h 15 sans changement, grâce à un bogie à écartement variable à Zweisimmen. Il est entré en service le 11 décembre 2022 et circule deux fois par jour dans chaque sens.',
        de: 'Ja. Der GoldenPass Express fährt ohne Umsteigen in 3 Std. 15 von Montreux nach Interlaken, dank eines Rollbocks mit variabler Spurweite in Zweisimmen. Er verkehrt seit dem 11. Dezember 2022, zweimal täglich in jede Richtung.',
      },
    },
  ],
