...
// Sources in data/SOURCES-brienz.md (checked 16/09/2026). No number without a source.
export const brienz: DestinationGuide = {
  slug: 'brienz',
  stamp: 'generic',
  updated: '2026-09-16',
  meta: {
  ...
  title: { en: 'Where to stay in Brienz', fr: 'Où dormir à Brienz', de: 'Wo übernachten in Brienz' },
  intro: {
    en: 'Brienz sits at 566 m at the eastern end of the lake that carries its name, a municipality of 3261 residents (31 December 2021) spread over 5495 hectares, of which 703 are Lake Brienz itself. The village is on the Zentralbahn line between Interlaken Ost, 17 minutes away, and Lucerne, 1 hour 27 minutes away, with the Luzern-Interlaken Express calling here. It is not car-free: the main road and the railway both run along the shore through the village. Brienz calls itself a carving village, home to a School for Woodcarving and a Violin Making School, and is the valley station of the steam-powered Brienz Rothorn Bahn, opened in 1892.',
    fr: 'Brienz se trouve à 566 m d’altitude, à l’extrémité est du lac qui porte son nom, commune de 3261 habitants (31 décembre 2021) répartie sur 5495 hectares, dont 703 pour le lac de Brienz lui-même. Le village se trouve sur la ligne du Zentralbahn entre Interlaken Ost, à 17 minutes, et Lucerne, à 1 h 27, desservie par le Luzern-Interlaken Express. Il n’est pas sans voiture : la route principale et la voie ferrée longent toutes deux la rive à travers le village. Brienz se définit comme un village de sculpteurs sur bois, avec une école de sculpture sur bois et une école de lutherie, et c’est la gare de départ du train à vapeur du Rothorn, ouvert en 1892.',
  ...
  stats: [
    ...
    { value: '1892', label: { en: 'the year the Rothorn steam railway opened, 16 June', fr: 'l’année d’ouverture du train à vapeur du Rothorn, le 16 juin', de: 'Eröffnungsjahr der Rothorn-Dampfbahn, 16. Juni' } },
    { value: '17', label: { en: 'minutes by train from Interlaken Ost', fr: 'minutes de train depuis Interlaken Ost', de: 'Zugminuten ab Interlaken Ost' } },
  ],
  hero: {
    photo: '/photos/brienz.jpg',
    caption: { en: 'Brienz strung along the shore of its lake, seen from above the Fluh tunnel.', fr: 'Brienz égrené le long de son lac, vu depuis au-dessus du tunnel du Fluh.', de: 'Brienz am Ufer seines Sees, von oberhalb des Fluh-Tunnels aus gesehen.' },
    credit: { author: 'André Schild', license: 'CC BY-SA 3.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/3.0/', source: 'https://commons.wikimedia.org/wiki/File:Brienz_Dorf.jpg' },
  },
  sectors: [
    {
      title: { en: 'Hauptstrasse and the lakefront', fr: 'La Hauptstrasse et le bord du lac', de: 'Hauptstrasse und Seeufer' },
      walk: { en: 'Station, boat landing, Rothorn Bahn', fr: 'Gare, embarcadère, Rothorn Bahn', de: 'Bahnhof, Schiffssteg, Rothorn Bahn' },
      text: {
        en: 'The main street runs along the shore, with the SBB station, the Rothorn Bahn valley station and the boat landing all on this stretch. Hotel Weisses Kreuz, Hotel Brienzerburli and Seehotel Bären all stand directly on the water here.',
        fr: 'La rue principale longe la rive, avec la gare CFF, la station de départ du Rothorn Bahn et l’embarcadère tous sur ce même tronçon. L’Hôtel Weisses Kreuz, l’Hôtel Brienzerburli et le Seehotel Bären se trouvent tous directement au bord de l’eau ici.',
        de: 'Die Hauptstrasse verläuft dem Ufer entlang, mit dem SBB-Bahnhof, der Talstation der Rothorn Bahn und dem Schiffssteg alle auf diesem Abschnitt. Hotel Weisses Kreuz, Hotel Brienzerburli und Seehotel Bären liegen hier alle direkt am Wasser.',
      },
      points: [
    ...
    },
    {
      ...
      walk: { en: 'The woodcarving school and the view', fr: 'L’école de sculpture sur bois et la vue', de: 'Schule für Holzbildhauerei und Aussicht' },
      text: {
        en: 'Hotel Lindenhof sits in its own park above the lake, with a view towards the Brienzer Rothorn. The School for Woodcarving stands at Schleegasse 1, in the village behind the main street.',
        fr: 'L’Hôtel Lindenhof se dresse dans son propre parc au-dessus du lac, avec une vue vers le Brienzer Rothorn. L’école de sculpture sur bois se trouve au Schleegasse 1, dans le village en retrait de la rue principale.',
        de: 'Das Hotel Lindenhof liegt in seinem eigenen Park oberhalb des Sees, mit Blick zum Brienzer Rothorn. Die Schule für Holzbildhauerei liegt an der Schleegasse 1, im Dorf hinter der Hauptstrasse.',
      },
      points: [
    ...
    },
    {
      ...
      walk: { en: 'Reached by boat, not on foot', fr: 'Accessible par bateau, pas à pied', de: 'Nur mit dem Schiff erreichbar' },
      text: {
        en: 'Grandhotel Giessbach, opened in 1875, stands above the Giessbach falls on the far shore, reached by BLS boat and then the 1891 funicular. It is a sector reached by water, not by walking from the village.',
        fr: 'Le Grandhotel Giessbach, ouvert en 1875, se dresse au-dessus des chutes du Giessbach sur l’autre rive, accessible par bateau BLS puis par le funiculaire de 1891. C’est un secteur qu’on rejoint par l’eau, pas à pied depuis le village.',
        de: 'Das Grandhotel Giessbach, eröffnet 1875, steht oberhalb des Giessbachfalls am gegenüberliegenden Ufer, erreichbar mit dem BLS-Schiff und anschliessend der Standseilbahn von 1891. Dieser Ortsteil wird über das Wasser erreicht, nicht zu Fuss vom Dorf aus.',
      },
      points: [
  ...
  hotels: [
    {
      ...
      facts: [
        { en: 'Hauptstrasse 143, directly on Lake Brienz, 45 hotel beds', fr: 'Hauptstrasse 143, directement au bord du lac de Brienz, 45 lits', de: 'Hauptstrasse 143, direkt am Brienzersee, 45 Hotelbetten' },
    ...
    },
    {
      ...
      sector: { en: 'Hauptstrasse, on the lake', fr: 'Hauptstrasse, au bord du lac', de: 'Hauptstrasse, am See' },
      facts: [
        { en: 'Hauptstrasse 11, on the Brienzersee', fr: 'Hauptstrasse 11, sur le lac de Brienz', de: 'Hauptstrasse 11, am Brienzersee' },
    ...
    },
    {
      ...
      facts: [
        { en: 'Lindenhofweg 15, 43 theme rooms spread over 5 houses in the hotel park', fr: 'Lindenhofweg 15, 43 chambres à thème réparties sur 5 maisons dans le parc de l’hôtel', de: 'Lindenhofweg 15, 43 Themenzimmer verteilt auf 5 Häuser im Hotelpark' },
    ...
    },
    {
      ...
      facts: [
        { en: 'Opened in 1875, architect Horace Edouard Davinet, above the Giessbach falls on the south shore', fr: 'Ouvert en 1875, architecte Horace Edouard Davinet, au-dessus des chutes du Giessbach sur la rive sud', de: 'Eröffnet 1875, Architekt Horace Edouard Davinet, oberhalb des Giessbachfalls am Südufer' },
  ...
  hotelsNote: {
    en: 'Facts taken from each hotel’s own website on 16 September 2026. No ratings or reviews on this guide. Grandhotel Giessbach sits on the far shore, reached only by boat and funicular, not on foot from the village.',
    fr: 'Faits relevés sur le site de chaque hôtel le 16 septembre 2026. Aucune note ni aucun avis sur ce guide. Le Grandhotel Giessbach se trouve sur l’autre rive, accessible uniquement par bateau et funiculaire, pas à pied depuis le village.',
    de: 'Fakten von der Website des jeweiligen Hotels, Stand 16. September 2026. Keine Bewertungen oder Rezensionen. Das Grandhotel Giessbach liegt am gegenüberliegenden Ufer, nur mit Schiff und Standseilbahn erreichbar, nicht zu Fuss vom Dorf aus.',
  },
  calendar: {
    title: { en: 'What runs, month by month', fr: 'Ce qui fonctionne, mois par mois', de: 'Was fährt, Monat für Monat' },
    rows: [
      { name: { en: 'Rothorn steam railway', fr: 'Train à vapeur du Rothorn', de: 'Rothorn-Dampfbahn' }, months: ['x', 'x', 'x', 'x', 'x', 'r', 'o', 'o', 'o', 'r', 'x', 'x'] },
      { name: { en: 'Ballenberg open-air museum', fr: 'Musée en plein air de Ballenberg', de: 'Freilichtmuseum Ballenberg' }, months: ['x', 'x', 'x', 'r', 'o', 'o', 'o', 'o', 'o', 'o', 'r', 'x'] },
      { name: { en: 'Giessbach funicular', fr: 'Funiculaire de Giessbach', de: 'Giessbachbahn' }, months: ['x', 'x', 'x', 'o', 'o', 'o', 'o', 'o', 'o', 'o', 'x', 'x'] },
    ],
    note: {
      en: '2026. Rothorn steam railway: season 6 June to 25 October 2026. Ballenberg: 9 April to 1 November 2026, daily 10:00 to 17:00. Giessbach funicular: April to October, maximum 40 passengers a trip, direct connections with the BLS boats. Sources: brienz-rothorn-bahn.ch, ballenberg.ch, giessbach.ch, checked 16 September 2026.',
      fr: '2026. Train à vapeur du Rothorn : saison du 6 juin au 25 octobre 2026. Ballenberg : du 9 avril au 1er novembre 2026, tous les jours de 10h00 à 17h00. Funiculaire de Giessbach : avril à octobre, 40 passagers maximum par trajet, correspondances directes avec les bateaux BLS. Sources : brienz-rothorn-bahn.ch, ballenberg.ch, giessbach.ch, vérifiées le 16 septembre 2026.',
      de: '2026. Rothorn-Dampfbahn: Saison 6. Juni bis 25. Oktober 2026. Ballenberg: 9. April bis 1. November 2026, täglich 10.00 bis 17.00 Uhr. Giessbachbahn: April bis Oktober, maximal 40 Fahrgäste pro Fahrt, direkte Anschlüsse an die BLS-Schiffe. Quellen: brienz-rothorn-bahn.ch, ballenberg.ch, giessbach.ch, geprüft am 16. September 2026.',
    },
  },
  practical: {
    title: { en: 'Getting around Brienz, in practice', fr: 'Se déplacer à Brienz, en pratique', de: 'Unterwegs in Brienz, in der Praxis' },
    items: [
      {
      ...
      },
      {
        ...
        text: {
          en: 'The Rothorn Bahn fare page lists only its own full fares, adult return CHF 98 plus CHF 8 for a seat guarantee, with no Swiss Travel Pass line. Neither Ballenberg nor Grandhotel Giessbach states pass coverage either: confirm at the counter before assuming a discount.',
          fr: 'La page tarifaire du Rothorn Bahn n’indique que ses propres tarifs plein prix, aller-retour adulte CHF 98 plus CHF 8 pour la garantie de place, sans aucune ligne sur le Swiss Travel Pass. Ni Ballenberg ni le Grandhotel Giessbach n’indiquent non plus de couverture par le pass : à confirmer au guichet avant de présumer d’une réduction.',
          de: 'Die Tarifseite der Rothorn Bahn nennt nur die eigenen Volltarife, Erwachsene retour CHF 98 plus CHF 8 für die Platzgarantie, ohne jede Zeile zum Swiss Travel Pass. Weder Ballenberg noch das Grandhotel Giessbach nennen eine Pass-Abdeckung: am Schalter bestätigen lassen, bevor man von einer Ermässigung ausgeht.',
        },
      },
    ],
  },
  seasons: {
    summer: {
      ...
      facts: [
        ...
        { value: '98', label: { en: 'CHF, adult return on the Rothorn Bahn, seat guarantee CHF 8 extra', fr: 'CHF, aller-retour adulte sur le Rothorn Bahn, garantie de place CHF 8 en plus', de: 'CHF, Erwachsene retour auf der Rothorn Bahn, Platzgarantie CHF 8 zusätzlich' } },
        { value: '9.4 → 1.11', label: { en: 'Ballenberg open-air museum, daily 10:00 to 17:00', fr: 'musée en plein air de Ballenberg, tous les jours de 10h00 à 17h00', de: 'Freilichtmuseum Ballenberg, täglich 10.00 bis 17.00 Uhr' } },
      ],
      note: {
        en: 'Sources: brienz-rothorn-bahn.ch, ballenberg.ch, checked 16 September 2026.',
        fr: 'Sources : brienz-rothorn-bahn.ch, ballenberg.ch, vérifiées le 16 septembre 2026.',
        de: 'Quellen: brienz-rothorn-bahn.ch, ballenberg.ch, geprüft am 16. September 2026.',
      },
    },
    winter: {
      ...
      facts: [
        ...
        { value: '21.10 → 20.3', label: { en: 'Grandhotel Giessbach winter opening, Wednesday to Sunday', fr: 'ouverture d’hiver du Grandhotel Giessbach, du mercredi au dimanche', de: 'Winteröffnung des Grandhotel Giessbach, Mittwoch bis Sonntag' } },
      ...
      note: {
        en: 'Sources: ballenberg.ch, giessbach.ch, bls-schiff.ch, checked 16 September 2026.',
        fr: 'Sources : ballenberg.ch, giessbach.ch, bls-schiff.ch, vérifiées le 16 septembre 2026.',
        de: 'Quellen: ballenberg.ch, giessbach.ch, bls-schiff.ch, geprüft am 16. September 2026.',
      },
    },
  },
  doing: {
    ...
    groups: [
      {
        kind: 'ride',
        title: { en: 'Steam train and lake funicular', fr: 'Train à vapeur et funiculaire du lac', de: 'Dampfbahn und Seebahn' },
        items: [
          {
          ...
          {
            name: { en: 'The Giessbach funicular', fr: 'Le funiculaire de Giessbach', de: 'Die Giessbachbahn' },
            meta: { en: 'built 1891 · April to October', fr: 'construit en 1891 · avril à octobre', de: 'erbaut 1891 · April bis Oktober' },
            text: {
              en: 'Described by the Grandhotel as one of the oldest funiculars in the world, still using switch rails based on the original 1891 design, with a maximum of 40 passengers a trip and direct connections with the BLS boats.',
              fr: 'Décrit par le Grandhotel comme l’un des plus anciens funiculaires au monde, utilisant toujours des aiguillages conçus sur le modèle original de 1891, avec un maximum de 40 passagers par trajet et des correspondances directes avec les bateaux BLS.',
              de: 'Vom Grandhotel als eine der ältesten Standseilbahnen der Welt beschrieben, noch immer mit Weichen nach dem ursprünglichen Entwurf von 1891, mit maximal 40 Fahrgästen pro Fahrt und direkten Anschlüssen an die BLS-Schiffe.',
            },
          },
        ],
      },
      {
        kind: 'local',
        title: { en: 'The two craft schools', fr: 'Les deux écoles d’artisanat', de: 'Die zwei Handwerksschulen' },
        items: [
          {
            name: { en: 'School for Woodcarving Brienz', fr: 'École de sculpture sur bois de Brienz', de: 'Schule für Holzbildhauerei Brienz' },
            meta: { en: 'Schleegasse 1 · six wood professions', fr: 'Schleegasse 1 · six métiers du bois', de: 'Schleegasse 1 · sechs Holzberufe' },
            text: {
              en: 'An innovative training workshop and vocational school covering six artisanal wood professions, in a village the municipality calls a carving village with a long tradition in wood processing.',
              fr: 'Un atelier de formation innovant et une école professionnelle couvrant six métiers artisanaux du bois, dans un village que la commune appelle village de sculpteurs sur bois, à la longue tradition de travail du bois.',
              de: 'Ein innovativer Ausbildungsbetrieb und eine Berufsschule für sechs handwerkliche Holzberufe, in einem Dorf, das die Gemeinde als Schnitzlerdorf mit langer Tradition in der Holzverarbeitung bezeichnet.',
            },
          },
          {
            name: { en: 'Swiss Violin Making School', fr: 'École suisse de lutherie', de: 'Geigenbauschule Brienz' },
            meta: { en: 'traditional and innovative techniques', fr: 'techniques traditionnelles et innovantes', de: 'traditionelle und innovative Techniken' },
            text: {
              en: 'Teaches traditional work techniques alongside the use of innovative technologies, a modern training location the municipality calls a special educational institution of world renown.',
              fr: 'Enseigne les techniques de travail traditionnelles aux côtés de technologies innovantes, un lieu de formation moderne que la commune qualifie d’établissement de formation particulier, de renommée mondiale.',
              de: 'Lehrt traditionelle Arbeitstechniken neben dem Einsatz innovativer Technologien, ein moderner Ausbildungsort, den die Gemeinde als besondere Bildungsstätte von Weltruf bezeichnet.',
            },
          },
        ],
      },
      {
        kind: 'walk',
        title: { en: 'Ballenberg and the shore', fr: 'Ballenberg et le rivage', de: 'Ballenberg und das Ufer' },
        items: [
          {
            name: 'Ballenberg',
          ...
          {
            name: { en: 'The lakeside promenade', fr: 'La promenade au bord du lac', de: 'Die Seepromenade' },
            meta: { en: '2 km · from Hotel Weisses Kreuz', fr: '2 km · depuis l’Hôtel Weisses Kreuz', de: '2 km · ab Hotel Weisses Kreuz' },
            text: {
              en: 'A 2 km lakeside promenade that, by Hotel Weisses Kreuz’s own description, starts at its door and runs along the shore.',
              fr: 'Une promenade lacustre de 2 km qui, selon les mots mêmes de l’Hôtel Weisses Kreuz, débute à sa porte et longe la rive.',
              de: 'Eine 2 km lange Seepromenade, die laut eigener Beschreibung des Hotels Weisses Kreuz vor dessen Tür beginnt und dem Ufer entlang führt.',
            },
          },
        ],
      },
    ...
    note: {
      en: 'Seasons, times and prices come from Brienz Rothorn Bahn, Ballenberg, the School for Woodcarving, the Swiss Violin Making School and the hotels’ own sites, checked on 16 September 2026. We publish no ratings and no route descriptions: check conditions on the spot before you set off.',
      fr: 'Saisons, horaires et tarifs viennent du Brienz Rothorn Bahn, de Ballenberg, de l’école de sculpture sur bois, de l’école suisse de lutherie et des sites des hôtels eux-mêmes, vérifiés le 16 septembre 2026. Nous ne publions ni notes ni descriptifs d’itinéraires : renseignez-vous sur place avant de partir.',
      de: 'Saisons, Zeiten und Preise stammen von der Brienz Rothorn Bahn, von Ballenberg, der Schule für Holzbildhauerei, der Geigenbauschule und den Websites der Hotels selbst, geprüft am 16. September 2026. Wir veröffentlichen keine Bewertungen und keine Routenbeschreibungen: Erkundigen Sie sich vor Ort, bevor Sie losgehen.',
    },
  },
  faq: [
    {
  ...
  neighbours: ['interlaken', 'meiringen', 'thun', 'grindelwald'],
}
