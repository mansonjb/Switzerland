...
const body: Record<Locale, React.JSX.Element> = {
  en: (
    <>
      ...
      <P>We have not stayed in every hotel listed, and we do not claim to. We do not publish ratings, reviews or prices: ratings change every week and prices depend on your dates.</P>
  ...
  fr: (
    <>
      ...
      <P>Nous n&apos;avons pas séjourné dans chaque hôtel cité, et nous ne le prétendons pas. Nous ne publions ni notes, ni avis, ni prix : les notes changent chaque semaine et les prix dépendent de vos dates.</P>
  ...
  de: (
    <>
      ...
      <P>Wir haben nicht in jedem genannten Hotel übernachtet und behaupten das auch nicht. Wir veröffentlichen keine Bewertungen und keine Preise: Bewertungen ändern sich wöchentlich, Preise hängen von Ihren Daten ab.</P>
